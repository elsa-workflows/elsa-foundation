...
namespace Elsa.Groundwork.Ledger.Tests;
...
internal sealed class GroundworkPersistenceReconciler
{
    ...
    [
        ...
        Map("runtime", "IWorkflowAlterationStore", "runtime-workflow-alteration", "WorkflowAlterationPlanDocumentKind"),
        Map("runtime", "IWorkflowAlterationStore", "runtime-workflow-alteration", "WorkflowAlterationJobDocumentKind"),
        new("runtime", "IWorkflowAlterationCheckpointWriter", "runtime-workflow-alteration", null),
        ...
        Map("iam", "IPagedRoleStore", "iam-role", "IdentityRoleDocumentKind"),
        Map("iam", "IApplicationStore", "iam-application", "IdentityApplicationDocumentKind"),
        Map("iam", "IRevisionAwareApplicationStore", "iam-application", "IdentityApplicationDocumentKind"),
        Map("iam", "ICredentialStore", "iam-credential", "IdentityCredentialDocumentKind"),
        Map("iam", "IRevisionAwareCredentialStore", "iam-credential", "IdentityCredentialDocumentKind"),
        ...
        Map("iam", "IPagedExternalIdentityStore", "iam-external-identity", "ExternalLoginDocumentKind"),
        ...
        Map("iam", "IPagedClaimMappingStore", "iam-claim-mapping", "IdentityClaimMappingDocumentKind"),
        Map("iam", "IProviderConfigurationStore", "iam-provider-configuration-tenant", "IdentityProviderConfigurationDocumentKind"),
        Map("iam", "IProviderConfigurationStore", "iam-provider-configuration-global", "IdentityGlobalProviderConfigurationDocumentKind"),
