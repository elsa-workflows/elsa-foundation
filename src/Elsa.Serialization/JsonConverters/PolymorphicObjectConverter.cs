...
namespace Elsa.Serialization.JsonConverters
{
    /// <summary>
    ...
    /// </summary>
    public sealed class PolymorphicObjectConverter : JsonConverter<object>
    {
        ...
        public override object Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
        {
            ...
            if (isNewtonsoftObject)
            {
                ...
                return !string.IsNullOrWhiteSpace(newtonsoftJson) 
                    ? JObject.Parse(newtonsoftJson) 
                    : [];
            }
