namespace Elsa.Expressions.Core.Contracts
{
    public interface IMemoryBlockReference
    {
        ...
        /// </summary>
        bool IsDefined(IMemoryRegister register) => register.HasBlock(Id);

        /// <summary>
        /// Returns the value of the memory block.
        /// </summary>
        object? Get(IMemoryRegister memoryRegister) => GetBlock(memoryRegister).Value;
        ...
        /// Returns the value of the memory block.
        /// </summary>
        object? Get(IExpressionExecutionContext context) => context.Get(this);
        ...
        /// Returns the value of the memory block.
        /// </summary>
        bool TryGet(IExpressionExecutionContext context, out object? value) => context.TryGet(this, out value);

        /// <summary>
        /// Sets the value of the memory block.
        /// </summary>
        void Set(IMemoryRegister memoryRegister, object? value, Action<IMemoryBlock>? configure = null)
        {
        ...
        /// Sets the value of the memory block.
        /// </summary>
        void Set(IExpressionExecutionContext context, object? value, Action<IMemoryBlock>? configure = null)
            => context.Set(this, value, configure);

        /// <summary>
        /// Returns the <see cref="MemoryBlock"/> pointed to by the specified memory block reference.
        /// </summary>
        IMemoryBlock GetBlock(IMemoryRegister memoryRegister) => memoryRegister.TryGetBlock(Id, out var location)
            ? location
