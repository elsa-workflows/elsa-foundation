...
import { createAdminRegistry } from "../app/registry";
import { isVersionRangeCompatible, loadAdminModules } from "../app/loader";

describe("admin module loader", () => {
