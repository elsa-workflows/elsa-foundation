...
[ShellFeature(
    ...
    Description = "Replaces the default in-memory secrets repository with a Groundwork-backed repository. Do not enable another Secrets persistence backend in the same shell."
)]
