...
See [`EXTENSION_POINTS.md`](EXTENSION_POINTS.md) for the overridable contracts (`IUpsertCommandGenerator`, `IElsaDbContextSchema`) and the `IEntitySavingHandler<,>` / `IEntityLoadingHandler<,>` contributor interfaces with their aggregating handlers.
