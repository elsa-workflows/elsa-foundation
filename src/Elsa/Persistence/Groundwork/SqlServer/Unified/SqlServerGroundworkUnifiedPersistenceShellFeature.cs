...
[ShellFeature(
    ...
    Description = "Backs the six provider-level Elsa persistence families with one admission-gated Groundwork SQL Server target: workflow runtime, secrets, distributed runtime, workflows design, activities design and workflows publishing. Identity remains an explicit host selection.",
    DependsOn = new object[] { "WorkflowsRuntimeResumption" })]
public class SqlServerGroundworkUnifiedPersistenceShellFeature : GroundworkPersistenceShellFeatureBase
{
    ...
    [ManifestSetting(
        ...
        Description = "SQL Server connection string for the single Groundwork provider connection.",
