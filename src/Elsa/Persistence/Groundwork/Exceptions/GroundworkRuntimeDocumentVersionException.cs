...
/// is unrecognized, newer than this build supports, or older with no upcaster chain to bring it to
/// the current version. Failing loudly here prevents silently hydrating suspended workflow state
