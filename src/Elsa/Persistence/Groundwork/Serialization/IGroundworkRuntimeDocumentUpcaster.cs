...
/// <see cref="IGroundworkRuntimeDocumentUpcasterRegistry"/> so a document at any historical version
/// reaches the kind's current version before deserialization.
/// </summary>
/// <remarks>
...
/// same change. Upcasting is lazy and read-time only; the write path always stamps the current
/// version, so documents re-baseline on their next save.
/// </remarks>
