...
public static class ElsaRuntimeV2StorageManifest
{
    ...
    // Prepared claim projections for the Elsa scheduler adapter. Groundwork #291 must add a composite
    // owner+token compare-and-delete before a renewal-stable consume can be enabled.
