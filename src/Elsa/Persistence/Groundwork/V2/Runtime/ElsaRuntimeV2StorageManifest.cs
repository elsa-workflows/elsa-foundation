...
public static class ElsaRuntimeV2StorageManifest
{
    ...
    [
        ...
        Unit(WorkflowExecutableSourceReferenceDocumentKind, "runtime_workflow_executable_source_reference", [String(CollectionField, 128), String(ArtifactIdField, 128), String(ScopeField), DateTime(ExpiresAtField), Boolean(IsRetiredField), String(WorkflowExecutableSourceReferenceIdField, 128)], [Index(ByCollectionIndex, CollectionField), Index(ByArtifactIndex, ArtifactIdField), Index(ByScopeIndex, ScopeField), Index(ByExpiresAtIndex, ExpiresAtField), Index(ByRetiredIndex, IsRetiredField), IncludedIndex("by_artifact_and_document_id", ArtifactIdField, WorkflowExecutableSourceReferenceIdField), IncludedIndex("by_artifact_retired_expiry_and_document_id", ArtifactIdField, IsRetiredField, ExpiresAtField, WorkflowExecutableSourceReferenceIdField), IncludedIndex("by_collection_and_document_id", CollectionField, WorkflowExecutableSourceReferenceIdField), IncludedIndex("by_collection_retired_expiry_and_document_id", CollectionField, IsRetiredField, ExpiresAtField, WorkflowExecutableSourceReferenceIdField), IncludedIndex("by_expiry_and_document_id", ExpiresAtField, WorkflowExecutableSourceReferenceIdField), IncludedIndex("by_retired_and_document_id", IsRetiredField, ExpiresAtField, WorkflowExecutableSourceReferenceIdField), IncludedIndex("by_scope_and_document_id", ScopeField, WorkflowExecutableSourceReferenceIdField), IncludedIndex("by_scope_retired_expiry_and_document_id", ScopeField, IsRetiredField, ExpiresAtField, WorkflowExecutableSourceReferenceIdField)]),
        ...
        Unit(WorkflowTestScopeDocumentKind, "runtime_workflow_test_scope", [String(CollectionField, 128), String(StateField, 32), String(ScopeIdField, 128), DateTime(ExpiresAtField)], [Index(ByCollectionIndex, CollectionField), Index(ByExpiresAtIndex, ExpiresAtField), Index(ByScopeIdIndex, ScopeIdField), Index("by_state_and_expires_at", StateField, ScopeIdField, ExpiresAtField), Index("by_state_and_scope_id", StateField, ScopeIdField), Index(ByStatusIndex, StateField)]),
        ...
        Unit(IncidentStateDocumentKind, "runtime_incident_state", [String(WorkflowExecutionIdField, 128), String(StatusField, 32), DateTime(CreatedAtField), String(IncidentIdField, 128)], [IncludedIndex("by_status_created_at_workflow_and_incident", StatusField, CreatedAtField, WorkflowExecutionIdField, IncidentIdField), Index(ByWorkflowExecutionIndex, WorkflowExecutionIdField)]),
