        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<string>(type: "TEXT", maxLength: 64, nullable: false),
                    TenantId = table.Column<string>(type: "TEXT", nullable: false),
                    TenantLookupKey = table.Column<string>(type: "TEXT", unicode: false, maxLength: 64, nullable: false),
                    Provider = table.Column<string>(type: "TEXT", nullable: false),
                    ProviderLookupKey = table.Column<string>(type: "TEXT", unicode: false, maxLength: 64, nullable: false),
                    RuleId = table.Column<string>(type: "TEXT", nullable: false),
                    RuleLookupKey = table.Column<string>(type: "TEXT", unicode: false, maxLength: 64, nullable: false),
                    RuleIdOrderKey = table.Column<byte[]>(type: "BLOB", maxLength: 802, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<string>(type: "TEXT", maxLength: 64, nullable: false),
                    TenantId = table.Column<string>(type: "TEXT", nullable: false),
                    TenantLookupKey = table.Column<string>(type: "TEXT", nullable: false),
                    CredentialId = table.Column<string>(type: "TEXT", nullable: false),
                    CredentialLookupKey = table.Column<string>(type: "TEXT", nullable: false),
                    ...
                    ExpiresAt = table.Column<string>(type: "TEXT", maxLength: 35, nullable: true),
                    Revision = table.Column<long>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NormalizedEmailKey = table.Column<string>(type: "TEXT", unicode: false, maxLength: 64, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProviderSubjectLookupKey = table.Column<string>(type: "TEXT", unicode: false, maxLength: 64, nullable: false),
                    ExternalOrderKey = table.Column<byte[]>(type: "BLOB", maxLength: 1604, nullable: false),
                    UserId = table.Column<string>(type: "TEXT", nullable: false),
                    UserLookupKey = table.Column<string>(type: "TEXT", unicode: false, maxLength: 64, nullable: false),
                    LinkedAt = table.Column<string>(type: "TEXT", maxLength: 35, nullable: false),
                    LastSeenAt = table.Column<string>(type: "TEXT", maxLength: 35, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "TEXT", maxLength: 64, nullable: false),
                    MutationReceiptId = table.Column<string>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RoleLookupKey = table.Column<string>(type: "TEXT", unicode: false, maxLength: 64, nullable: false),
                    ClaimType = table.Column<string>(type: "TEXT", nullable: false),
                    ClaimValue = table.Column<string>(type: "TEXT", nullable: true),
                    ClaimKey = table.Column<string>(type: "TEXT", unicode: false, maxLength: 64, nullable: false),
                    Revision = table.Column<long>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NormalizedRoleNameKey = table.Column<string>(type: "TEXT", unicode: false, maxLength: 64, nullable: false),
                    RoleId = table.Column<string>(type: "TEXT", nullable: false),
                    Revision = table.Column<long>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TenantLookupKey = table.Column<string>(type: "TEXT", unicode: false, maxLength: 64, nullable: false),
                    RoleId = table.Column<string>(type: "TEXT", nullable: false),
                    RoleIdOrderKey = table.Column<byte[]>(type: "BLOB", maxLength: 802, nullable: false),
                    Name = table.Column<string>(type: "TEXT", nullable: false),
                    NormalizedName = table.Column<string>(type: "TEXT", nullable: true),
                    NormalizedNameKey = table.Column<string>(type: "TEXT", unicode: false, maxLength: 64, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NormalizedUserNameKey = table.Column<string>(type: "TEXT", unicode: false, maxLength: 64, nullable: false),
                    UserId = table.Column<string>(type: "TEXT", nullable: false),
                    Revision = table.Column<long>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "TEXT", nullable: false),
                    TokenKey = table.Column<string>(type: "TEXT", unicode: false, maxLength: 64, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TenantLookupKey = table.Column<string>(type: "TEXT", unicode: false, maxLength: 64, nullable: false),
                    UserId = table.Column<string>(type: "TEXT", nullable: false),
                    UserIdOrderKey = table.Column<byte[]>(type: "BLOB", maxLength: 802, nullable: false),
                    UserName = table.Column<string>(type: "TEXT", nullable: false),
                    NormalizedUserName = table.Column<string>(type: "TEXT", nullable: true),
                    NormalizedUserNameKey = table.Column<string>(type: "TEXT", unicode: false, maxLength: 64, nullable: true),
                    Email = table.Column<string>(type: "TEXT", nullable: true),
                    NormalizedEmail = table.Column<string>(type: "TEXT", nullable: true),
                    NormalizedEmailKey = table.Column<string>(type: "TEXT", unicode: false, maxLength: 64, nullable: true),
                    ...
                    LockoutEnd = table.Column<string>(type: "TEXT", maxLength: 35, nullable: true),
