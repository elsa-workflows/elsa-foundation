        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: false),
                    TenantId = table.Column<string>(type: "text", nullable: false),
                    TenantLookupKey = table.Column<string>(type: "character varying(64)", unicode: false, maxLength: 64, nullable: false),
                    Provider = table.Column<string>(type: "text", nullable: false),
                    ProviderLookupKey = table.Column<string>(type: "character varying(64)", unicode: false, maxLength: 64, nullable: false),
                    RuleId = table.Column<string>(type: "text", nullable: false),
                    RuleLookupKey = table.Column<string>(type: "character varying(64)", unicode: false, maxLength: 64, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NormalizedEmailKey = table.Column<string>(type: "character varying(64)", unicode: false, maxLength: 64, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProviderSubjectLookupKey = table.Column<string>(type: "character varying(64)", unicode: false, maxLength: 64, nullable: false),
                    ExternalOrderKey = table.Column<byte[]>(type: "bytea", maxLength: 1604, nullable: false),
                    UserId = table.Column<string>(type: "text", nullable: false),
                    UserLookupKey = table.Column<string>(type: "character varying(64)", unicode: false, maxLength: 64, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RoleLookupKey = table.Column<string>(type: "character varying(64)", unicode: false, maxLength: 64, nullable: false),
                    ClaimType = table.Column<string>(type: "text", nullable: false),
                    ClaimValue = table.Column<string>(type: "text", nullable: true),
                    ClaimKey = table.Column<string>(type: "character varying(64)", unicode: false, maxLength: 64, nullable: false),
                    Revision = table.Column<long>(type: "bigint", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NormalizedRoleNameKey = table.Column<string>(type: "character varying(64)", unicode: false, maxLength: 64, nullable: false),
                    RoleId = table.Column<string>(type: "text", nullable: false),
                    Revision = table.Column<long>(type: "bigint", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NormalizedNameKey = table.Column<string>(type: "character varying(64)", unicode: false, maxLength: 64, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NormalizedUserNameKey = table.Column<string>(type: "character varying(64)", unicode: false, maxLength: 64, nullable: false),
                    UserId = table.Column<string>(type: "text", nullable: false),
                    Revision = table.Column<long>(type: "bigint", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "text", nullable: false),
                    TokenKey = table.Column<string>(type: "character varying(64)", unicode: false, maxLength: 64, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NormalizedUserNameKey = table.Column<string>(type: "character varying(64)", unicode: false, maxLength: 64, nullable: true),
                    Email = table.Column<string>(type: "text", nullable: true),
                    NormalizedEmail = table.Column<string>(type: "text", nullable: true),
                    NormalizedEmailKey = table.Column<string>(type: "character varying(64)", unicode: false, maxLength: 64, nullable: true),
