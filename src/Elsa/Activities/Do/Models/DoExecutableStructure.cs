...
/// <summary>
/// Compiled executable structure for a <c>Do</c> node: the executable node id of the optional
...
/// document.
/// </summary>
public sealed class DoExecutableStructure
{
    [JsonConstructor]
    public DoExecutableStructure(string? body = null) => Body = body;
