...
[ShellFeature(
    name: "ActivitiesFlowchartRuntime",
    DisplayName = "Activities Flowchart (Runtime)",
    Description = "Flowchart composite activity execution: the graph engine, join coordination and routing policies."
)]
public class ActivitiesFlowchartRuntimeFeature : IShellFeature
{
