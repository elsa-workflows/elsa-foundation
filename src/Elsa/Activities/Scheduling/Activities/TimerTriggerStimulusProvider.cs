...
/// <summary>
/// The <see cref="IActivityTriggerStimulusProvider"/> for the <see cref="Timer"/> start trigger. It
...
public sealed class TimerTriggerStimulusProvider : IActivityTriggerStimulusProvider
{
    ...
    public ActivityTriggerStimulusResult Describe(ExecutableNode node)
    {
        ...
        return ActivityTriggerStimulusResult.Recognized([TimerStimulus.DescribeTrigger(interval)]);
    }
}
