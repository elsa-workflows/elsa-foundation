...
public static class ActivitiesDesignApi
{
    ...
    private const string ReadPermission = "activity-design.read";
    private const string ManagePermission = "activity-design.manage";
    ...
    public static RouteGroupBuilder MapActivitiesDesignApi(IEndpointRouteBuilder endpoints)
    {
        ...
        Map(group.MapGet("/availability/settings", (RequestDelegate)HandleGetAvailabilitySettingsAsync), "AvailabilityGetSettings", ReadPermission, typeof(GetActivityAvailabilitySettings), typeof(ActivityAvailabilitySettings), descriptionMethod, ["*/*", "application/json"]);
        Map(group.MapGet("/availability/diagnostics", (RequestDelegate)HandleListAvailabilityDiagnosticsAsync), "AvailabilityListDiagnostics", ReadPermission, null, typeof(ActivityAvailabilityDiagnostics), descriptionMethod);
        Map(group.MapPut("/availability/settings", (RequestDelegate)HandleSaveAvailabilitySettingsAsync), "AvailabilitySaveSettings", ManagePermission, typeof(SaveActivityAvailabilitySettings), typeof(ActivityAvailabilitySettings), descriptionMethod, [JsonMediaType]);
        Map(group.MapGet("/authoring-capabilities", (RequestDelegate)HandleGetAuthoringCapabilitiesAsync), "AuthoringCapabilitiesGet", ReadPermission, null, typeof(ActivityAuthoringCapabilitiesView), descriptionMethod);
        Map(group.MapGet("/catalog", (RequestDelegate)HandleListCatalogAsync), "CatalogList", ReadPermission, typeof(ListActivityAuthoringCatalog), typeof(ActivityAuthoringCatalogView), descriptionMethod, ["*/*", "application/json"]);

        // Definitions, drafts, forks, and their authoring operations.
        Map(group.MapPost("/definitions", (RequestDelegate)HandleCreateDefinitionAsync), "DefinitionsAdd", ManagePermission, typeof(CreateReusableActivityDefinition), typeof(ReusableActivityDefinitionMutationView), descriptionMethod, [JsonMediaType], StatusCodes.Status201Created);
        Map(group.MapPost("/definitions/{definitionId}/fork-previews", (RequestDelegate)HandlePreviewForkAsync), "DefinitionsPreviewFork", ManagePermission, typeof(PreviewReusableActivityFork), typeof(ActivityForkPreviewView), descriptionMethod, [JsonMediaType]);
        Map(group.MapGet("/definitions", (RequestDelegate)HandleListDefinitionsAsync), "DefinitionsList", ReadPermission, typeof(ListReusableActivityDefinitions), typeof(ActivityManagementPageView<ReusableActivityDefinitionManagementView>), descriptionMethod, ["*/*", "application/json"]);
        Map(group.MapGet("/definitions/{definitionId}", (RequestDelegate)HandleGetDefinitionAsync), "DefinitionsGet", ReadPermission, typeof(GetReusableActivityDefinition), typeof(ReusableActivityDefinitionManagementView), descriptionMethod, ["*/*", "application/json"]);
        Map(group.MapPatch("/definitions/{definitionId}", (RequestDelegate)HandleUpdateDefinitionAsync), "DefinitionsUpdate", ManagePermission, typeof(UpdateReusableActivityDefinition), typeof(ActivityDefinitionIdentityView), descriptionMethod, [JsonMediaType]);
        Map(group.MapPut("/definitions/{definitionId}/recommendation", (RequestDelegate)HandleSetRecommendationAsync), "DefinitionsRecommendation", ManagePermission, typeof(SetRecommendedReusableActivityVersion), typeof(ActivityDefinitionRecommendationView), descriptionMethod, [JsonMediaType]);
        Map(group.MapGet("/definitions/picker", (RequestDelegate)HandlePickerAsync), "DefinitionsPicker", ReadPermission, typeof(ListRecommendedActivityDefinitions), typeof(RecommendedActivityDefinitionPageView), descriptionMethod, ["*/*", "application/json"]);
        Map(group.MapGet("/definitions/{definitionId}/drafts", (RequestDelegate)HandleListDraftsAsync), "DefinitionsListDrafts", ReadPermission, typeof(ListReusableActivityDrafts), typeof(ActivityManagementPageView<ReusableActivityDraftManagementView>), descriptionMethod, ["*/*", "application/json"]);
        Map(group.MapPost("/definitions/{definitionId}/drafts", (RequestDelegate)HandleCreateDraftAsync), "DefinitionsAddDraft", ManagePermission, typeof(CreateReusableActivityDraft), typeof(ReusableActivityDraftView), descriptionMethod, [JsonMediaType], StatusCodes.Status201Created);
        Map(group.MapGet("/definitions/{definitionId}/versions", (RequestDelegate)HandleListVersionsAsync), "DefinitionsListVersions", ReadPermission, typeof(ListReusableActivityVersions), typeof(ActivityManagementPageView<ReusableActivityVersionManagementView>), descriptionMethod, ["*/*", "application/json"]);

        Map(group.MapGet("/drafts/{draftId}", (RequestDelegate)HandleGetDraftAsync), "DraftsGet", ReadPermission, typeof(GetReusableActivityDraft), typeof(ReusableActivityDraftView), descriptionMethod, ["*/*", "application/json"]);
        Map(group.MapPut("/drafts/{draftId}", (RequestDelegate)HandleReplaceDraftAsync), "DraftsReplace", ManagePermission, typeof(ReplaceReusableActivityDraft), typeof(ReusableActivityDraftView), descriptionMethod, [JsonMediaType]);
        Map(group.MapPatch("/drafts/{draftId}/presentation", (RequestDelegate)HandleUpdateDraftPresentationAsync), "DraftsUpdatePresentation", ManagePermission, typeof(UpdateReusableActivityDraftPresentation), typeof(ReusableActivityDraftView), descriptionMethod, [JsonMediaType]);
        Map(group.MapPost("/drafts/{draftId}/conflict-copies", (RequestDelegate)HandleCreateConflictCopyAsync), "DraftsConflictCopy", ManagePermission, typeof(CreateReusableActivityDraftConflictCopy), typeof(ReusableActivityDraftView), descriptionMethod, [JsonMediaType], StatusCodes.Status201Created);
        Map(group.MapPost("/drafts/{draftId}/validate", (RequestDelegate)HandleValidateDraftAsync), "DraftsValidate", ManagePermission, typeof(ValidateReusableActivityDraft), typeof(ActivityDraftValidationView), descriptionMethod, [JsonMediaType]);
        Map(group.MapPost("/drafts/{draftId}/migrate-provider", (RequestDelegate)HandleMigrateProviderAsync), "DraftsMigrateProvider", ManagePermission, typeof(MigrateReusableActivityDraft), typeof(ReusableActivityDraftView), descriptionMethod, [JsonMediaType], StatusCodes.Status201Created);
        Map(group.MapPost("/drafts/{draftId}/contract-proposals", (RequestDelegate)HandleProposeContractAsync), "DraftsProposeContract", ManagePermission, typeof(ProposeReusableActivityContract), typeof(ActivityContractProposalView), descriptionMethod, [JsonMediaType]);
        Map(group.MapPost("/drafts/{draftId}/contract-proposals/apply", (RequestDelegate)HandleApplyContractProposalAsync), "DraftsApplyContractProposal", ManagePermission, typeof(ApplyReusableActivityContractProposal), typeof(ReusableActivityDraftView), descriptionMethod, [JsonMediaType]);
        Map(group.MapDelete("/drafts/{draftId}", (RequestDelegate)HandleDiscardDraftAsync), "DraftsDiscard", ManagePermission, typeof(DiscardReusableActivityDraft), typeof(void), descriptionMethod, ["*/*", "application/json"], StatusCodes.Status204NoContent);
        Map(group.MapPost("/drafts/{draftId}/diff", (RequestDelegate)HandlePreviewDraftDiffAsync), "DraftsDiff", ReadPermission, typeof(PreviewActivityDraftDiff), typeof(ActivityVersionDiffView), descriptionMethod, [JsonMediaType]);

        Map(group.MapPost("/fork-candidates/{candidateId}/apply", (RequestDelegate)HandleApplyForkAsync), "ForksApply", ManagePermission, typeof(ApplyReusableActivityFork), typeof(ActivityForkReceiptView), descriptionMethod, [JsonMediaType], StatusCodes.Status201Created);
        Map(group.MapGet("/forks/{idempotencyKey}", (RequestDelegate)HandleGetForkStatusAsync), "ForksGetStatus", ReadPermission, typeof(GetReusableActivityForkStatus), typeof(ActivityForkReceiptView), descriptionMethod, ["*/*", "application/json"]);

        // Version, dependency, diff, and lifecycle operations.
        Map(group.MapGet("/versions/{versionId}/dependencies", (RequestDelegate)HandleGetDependenciesAsync), "VersionsDependencies", ReadPermission, typeof(GetActivityDependencies), typeof(ActivityDependencyPageView), descriptionMethod, ["*/*", "application/json"]);
        Map(group.MapGet("/versions/{fromVersionId}/diff/{toVersionId}", (RequestDelegate)HandleCompareVersionsAsync), "VersionsDiff", ReadPermission, typeof(CompareActivityVersions), typeof(ActivityVersionDiffView), descriptionMethod, ["*/*", "application/json"]);
        Map(group.MapGet("/versions/{versionId}", (RequestDelegate)HandleGetVersionAsync), "VersionsGet", ReadPermission, typeof(GetReusableActivityVersion), typeof(ReusableActivityVersionView), descriptionMethod, ["*/*", "application/json"]);
        Map(group.MapPost("/versions/{versionId}/retire", (RequestDelegate)HandleRetireVersionAsync), "VersionsRetire", ManagePermission, typeof(RetireReusableActivityVersion), typeof(ReusableActivityVersionLifecycleView), descriptionMethod, [JsonMediaType]);
        Map(group.MapPost("/versions/{versionId}/restore", (RequestDelegate)HandleRestoreVersionAsync), "VersionsRestore", ManagePermission, typeof(RestoreReusableActivityVersion), typeof(ReusableActivityVersionLifecycleView), descriptionMethod, [JsonMediaType]);
        Map(group.MapPost("/versions/{versionId}/revoke", (RequestDelegate)HandleRevokeVersionAsync), "VersionsRevoke", ManagePermission, typeof(RevokeReusableActivityVersion), typeof(ReusableActivityVersionLifecycleView), descriptionMethod, [JsonMediaType]);

        // Upgrade plans are authoring operations with staged handoff and created-location semantics.
        Map(group.MapPost("/upgrade-plans", (RequestDelegate)HandleCreateUpgradePlanAsync), "UpgradePlansCreate", ManagePermission, typeof(CreateActivityUpgradePlan), typeof(ActivityUpgradePlanView), descriptionMethod, [JsonMediaType], StatusCodes.Status201Created);
        Map(group.MapGet("/upgrade-plans/{planId}", (RequestDelegate)HandleGetUpgradePlanAsync), "UpgradePlansGet", ReadPermission, typeof(GetActivityUpgradePlan), typeof(ActivityUpgradePlanView), descriptionMethod, ["*/*", "application/json"]);
        Map(group.MapPost("/upgrade-plans/{planId}/apply", (RequestDelegate)HandleApplyUpgradePlanAsync), "UpgradePlansApply", ManagePermission, typeof(ApplyActivityUpgradePlan), typeof(ActivityUpgradeApplyResultView), descriptionMethod, [JsonMediaType]);
        Map(group.MapGet("/upgrade-plans/{planId}/receipts/{receiptId}", (RequestDelegate)HandleGetUpgradeReceiptAsync), "UpgradePlansGetReceipt", ReadPermission, typeof(GetActivityUpgradeApplyReceipt), typeof(ActivityUpgradeApplyReceiptView), descriptionMethod, ["*/*", "application/json"]);
        Map(group.MapPost("/upgrade-plans/{planId}/refresh", (RequestDelegate)HandleRefreshUpgradePlanAsync), "UpgradePlansRefresh", ManagePermission, typeof(RefreshActivityUpgradePlan), typeof(ActivityUpgradePlanView), descriptionMethod, [JsonMediaType], StatusCodes.Status201Created);
