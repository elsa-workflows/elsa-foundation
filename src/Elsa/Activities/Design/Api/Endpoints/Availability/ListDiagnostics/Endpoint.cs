...
[LegacyProblems]
public sealed class Endpoint(IRequestSender sender) : ApiEndpointWithoutRequest<ActivityAvailabilityDiagnostics>
{
    ...
    public override Task<ActivityAvailabilityDiagnostics> HandleAsync(CancellationToken cancellationToken) =>
        sender.Send(new ListActivityAvailabilityDiagnostics(), cancellationToken);
}
