...
[AuthoringProblems]
public sealed class Endpoint(IActivityForkService service) : ApiEndpoint<ApplyReusableActivityFork, ActivityForkReceiptView>
{
    ...
    {
        var response = await service.ApplyAsync(command, cancellationToken);
