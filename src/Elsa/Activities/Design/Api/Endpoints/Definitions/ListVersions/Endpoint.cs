...
[AuthoringProblems]
public sealed class Endpoint(IRequestSender sender) : ApiEndpoint<ListReusableActivityVersions, ActivityManagementPageView<ReusableActivityVersionManagementView>>
{
