...
public sealed class BpmnInterchangePermissionContributor : IPermissionContributor
{
    ...
    [
        ...
        new(PermissionNames.BpmnInterchangeManage, "Manage BPMN interchange", "BPMN interchange", "Import BPMN interchange documents.", new HashSet<string> { PermissionNames.BpmnInterchangeRead })
    ];
}
