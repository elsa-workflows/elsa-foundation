        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ScopeId = table.Column<string>(type: "TEXT", maxLength: 64, nullable: false),
                    StreamId = table.Column<string>(type: "TEXT", maxLength: 64, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CategoryKey = table.Column<string>(type: "TEXT", maxLength: 64, nullable: false),
                    SourceKey = table.Column<string>(type: "TEXT", maxLength: 64, nullable: false),
                    ReplayToken = table.Column<string>(type: "TEXT", maxLength: 32, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ScopeId = table.Column<string>(type: "TEXT", maxLength: 64, nullable: false),
                    StreamId = table.Column<string>(type: "TEXT", maxLength: 64, nullable: false),
                    HighWater = table.Column<long>(type: "INTEGER", nullable: false),
                    AppendOperationCutoffTicks = table.Column<long>(type: "INTEGER", nullable: false),
