    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    ScopeKey = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
                    IdOrderKey = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
                    Id = table.Column<string>(type: "nvarchar(512)", maxLength: 512, nullable: false),
                    IdSearchKey = table.Column<string>(type: "nvarchar(max)", unicode: false, maxLength: 3584, nullable: false),
                    ResourceId = table.Column<string>(type: "nvarchar(512)", maxLength: 512, nullable: false),
                    ResourceIdSearchKey = table.Column<string>(type: "nvarchar(max)", unicode: false, maxLength: 3584, nullable: false),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    NameSearchKey = table.Column<string>(type: "nvarchar(max)", unicode: false, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ServiceNameKey = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    TraceId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    TraceIdSearchKey = table.Column<string>(type: "nvarchar(max)", unicode: false, maxLength: 1792, nullable: true),
                    SpanId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SpanIdSearchKey = table.Column<string>(type: "nvarchar(max)", unicode: false, maxLength: 1792, nullable: true),
                    SeverityText = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    SeveritySearchKey = table.Column<string>(type: "nvarchar(max)", unicode: false, nullable: false),
                    SeverityNumber = table.Column<int>(type: "int", nullable: true),
                    Body = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    BodySearchKey = table.Column<string>(type: "nvarchar(max)", unicode: false, nullable: false),
                    ...
                    IdSearchKey = table.Column<string>(type: "nvarchar(max)", unicode: false, maxLength: 896, nullable: false),
                    IdOrderKey = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    PayloadJson = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ScopeKey = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
                    Sequence = table.Column<long>(type: "bigint", nullable: false),
                    InstrumentId = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: false),
                    InstrumentIdSearchKey = table.Column<string>(type: "nvarchar(max)", unicode: false, maxLength: 1792, nullable: false),
                    InstrumentName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    InstrumentNameSearchKey = table.Column<string>(type: "nvarchar(max)", unicode: false, nullable: false),
                    ResourceId = table.Column<string>(type: "nvarchar(512)", maxLength: 512, nullable: false),
                    ResourceIdSearchKey = table.Column<string>(type: "nvarchar(max)", unicode: false, maxLength: 3584, nullable: false),
                    ServiceName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ServiceNameKey = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Id = table.Column<string>(type: "nvarchar(512)", maxLength: 512, nullable: false),
                    IdSearchKey = table.Column<string>(type: "nvarchar(max)", unicode: false, maxLength: 3584, nullable: false),
                    ServiceName = table.Column<string>(type: "nvarchar(512)", maxLength: 512, nullable: false),
                    ServiceNameSearchKey = table.Column<string>(type: "nvarchar(max)", unicode: false, maxLength: 3584, nullable: false),
                    ServiceNameKey = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
                    Status = table.Column<int>(type: "int", nullable: false),
                    LastSeenTicks = table.Column<long>(type: "bigint", nullable: false),
                    LastSeenOffsetMinutes = table.Column<short>(type: "smallint", nullable: false),
                    PayloadJson = table.Column<string>(type: "nvarchar(max)", nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ScopeKey = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
                    Sequence = table.Column<long>(type: "bigint", nullable: false),
                    TraceId = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: false),
                    TraceIdSearchKey = table.Column<string>(type: "nvarchar(max)", unicode: false, maxLength: 1792, nullable: false),
                    TraceKey = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
                    SpanId = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
                    SpanIdSearchKey = table.Column<string>(type: "nvarchar(max)", unicode: false, maxLength: 896, nullable: false),
                    SpanIdOrderKey = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
                    ResourceId = table.Column<string>(type: "nvarchar(512)", maxLength: 512, nullable: false),
                    ResourceIdSearchKey = table.Column<string>(type: "nvarchar(max)", unicode: false, maxLength: 3584, nullable: false),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    NameSearchKey = table.Column<string>(type: "nvarchar(max)", unicode: false, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TraceId = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: false),
                    TraceIdSearchKey = table.Column<string>(type: "nvarchar(max)", unicode: false, maxLength: 1792, nullable: false),
                    RootSpanId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Name = table.Column<string>(type: "nvarchar(571)", maxLength: 571, nullable: true),
                    NameSearchKey = table.Column<string>(type: "nvarchar(max)", unicode: false, maxLength: 3997, nullable: true),
                    Status = table.Column<int>(type: "int", nullable: false),
                    StartTimeTicks = table.Column<long>(type: "bigint", nullable: false),
                    StartTimeOffsetMinutes = table.Column<short>(type: "smallint", nullable: false),
                    EndTimeTicks = table.Column<long>(type: "bigint", nullable: false),
                    ...
                    PayloadJson = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ServiceMembershipJson = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    WorkflowMembershipJson = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ValueKey = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
                    Value = table.Column<string>(type: "nvarchar(512)", maxLength: 512, nullable: false),
                    ValueSearchKey = table.Column<string>(type: "nvarchar(3584)", maxLength: 3584, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdSearchKey = table.Column<string>(type: "nvarchar(max)", unicode: false, nullable: false),
                    IdOrderKey = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
                    PayloadJson = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
