...
/// redacted batch instance, which must be treated as read-only.
/// </summary>
/// <remarks>
...
/// ingestion was not accepted.
/// </remarks>
public interface IOpenTelemetryIngestionContributor
{
    ValueTask ContributeAsync(OpenTelemetryBatch redactedBatch, CancellationToken cancellationToken = default);
}
