...
/// <c>DraftValidated</c> (create/update) or uses it as the promotion gate (FR-024). Errors are
...
/// </remarks>
public sealed class DraftValidating(IWorkflowDefinitionDraft draft) : IEvent
{
