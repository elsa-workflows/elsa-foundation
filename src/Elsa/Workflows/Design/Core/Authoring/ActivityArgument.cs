...
public readonly struct ActivityArgument<T>
{
    ...
    private ActivityArgument(
        ActivityArgumentKind kind,
        T? literal,
        WorkflowValue<T>? source,
    ...
    public AuthoredValueConversionRequest? Conversion { get; }
    ...
    public ActivityArgument<T> WithConversion(AuthoredValueConversionRequest conversion) =>
        new(Kind, Literal, Source, _isExplicitNull, conversion ?? throw new ArgumentNullException(nameof(conversion)));
    public ActivityArgument<T> WithConversion(AuthoredValueConversionMode mode) =>
        WithConversion(new AuthoredValueConversionRequest(mode));
    public ActivityArgument<T> WithProfile(string id, string version) =>
        WithConversion(new AuthoredValueConversionRequest(
            AuthoredValueConversionMode.Profile,
            new AuthoredValueConversionProfile(id, version)));
...
public static class ActivityArgument
{
    ...
    public static AuthoredValueConversionRequest Auto() => new(AuthoredValueConversionMode.Auto);
    public static AuthoredValueConversionRequest None() => new(AuthoredValueConversionMode.None);
    public static AuthoredValueConversionRequest Json() => new(AuthoredValueConversionMode.Json);
    public static AuthoredValueConversionRequest Xml() => new(AuthoredValueConversionMode.Xml);
    public static AuthoredValueConversionRequest Profile(string id, string version) =>
        new(AuthoredValueConversionMode.Profile, new AuthoredValueConversionProfile(id, version));
}
