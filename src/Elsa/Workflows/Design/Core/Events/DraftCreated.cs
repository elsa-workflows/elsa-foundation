...
/// <c>DraftClonedFromVersion</c> event is therefore unnecessary — the provenance lives here.
/// </remarks>
public sealed class DraftCreated(string draftId, string workflowDefinitionId, string? sourceVersionId = null) : IEvent
{
