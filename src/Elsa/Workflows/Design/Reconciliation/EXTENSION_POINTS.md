...
- Workflow catalog persistence: [`Elsa.Workflows.Design.Persistence.EFCore/EXTENSION_POINTS.md`](../Elsa.Workflows.Design.Persistence.EFCore/EXTENSION_POINTS.md).
