...
internal static class DesignEntityConfigurations
{
    ...
    public static void ConfigureVersion(EntityTypeBuilder<WorkflowDefinitionVersion> b)
    {
        ...
        b.Property(x => x.Id).HasMaxLength(256);
        b.Property(x => x.TenantId).HasMaxLength(256);
        b.Property(x => x.DefinitionId).HasMaxLength(256);
        b.Property(x => x.Version).HasMaxLength(128);
        b.Property(x => x.SemVerSortKey).HasMaxLength(1024);
        ...
        b.HasIndex(x => new { x.TenantId, x.DefinitionId, x.SemVerSortKey, x.Id }).IsUnique();
        b.HasOne(x => x.Definition).WithMany().HasForeignKey(x => x.DefinitionId).OnDelete(DeleteBehavior.Cascade);
        b.Property(x => x.LastModifiedAt).IsConcurrencyToken();
        b.Ignore(x => x.State);
    }
    ...
    public static void ConfigureDraft(EntityTypeBuilder<WorkflowDefinitionDraft> b)
    {
        ...
        b.Property(x => x.Id).HasMaxLength(256);
        b.Property(x => x.TenantId).HasMaxLength(256);
        b.Property(x => x.WorkflowDefinitionId).HasMaxLength(256);
        b.Property(x => x.SourceVersionId).HasMaxLength(256);
        b.Property(x => x.StateSource).HasColumnType("TEXT");
        b.HasIndex(x => new { x.TenantId, x.WorkflowDefinitionId, x.LastModifiedAt, x.Id });
        b.HasOne(x => x.WorkflowDefinition).WithMany().HasForeignKey(x => x.WorkflowDefinitionId).OnDelete(DeleteBehavior.Cascade);
        b.Property(x => x.LastModifiedAt).IsConcurrencyToken();
        b.Ignore(x => x.State);
    }
    ...
    public static void ConfigureDraftLayout(EntityTypeBuilder<WorkflowDefinitionDraftLayout> b)
    {
        ...
        b.Property(x => x.Id).HasMaxLength(256);
        b.Property(x => x.TenantId).HasMaxLength(256);
        b.Property(x => x.WorkflowDefinitionDraftId).HasMaxLength(256);
        ...
        b.HasOne(x => x.WorkflowDefinitionDraft).WithOne().HasForeignKey<WorkflowDefinitionDraftLayout>(x => x.WorkflowDefinitionDraftId).OnDelete(DeleteBehavior.Cascade);
    ...
    public static void ConfigureVersionLayout(EntityTypeBuilder<WorkflowDefinitionVersionLayout> b)
    {
        ...
        b.Property(x => x.Id).HasMaxLength(256);
        b.Property(x => x.TenantId).HasMaxLength(256);
        b.Property(x => x.WorkflowDefinitionVersionId).HasMaxLength(256);
        b.Property<string>("RecordsJson").HasColumnType("TEXT");
        b.Property<string>("ActivityPresentationJson").HasColumnType("TEXT");
        b.HasIndex(x => new { x.TenantId, x.WorkflowDefinitionVersionId }).IsUnique();
        b.HasOne(x => x.WorkflowDefinitionVersion).WithOne().HasForeignKey<WorkflowDefinitionVersionLayout>(x => x.WorkflowDefinitionVersionId).OnDelete(DeleteBehavior.Cascade);
        b.Ignore(x => x.Records);
        b.Ignore(x => x.ActivityPresentation);
    ...
    public static void ConfigureOperation(EntityTypeBuilder<DesignOperationEntity> b)
    {
        ...
        b.HasIndex(x => new { x.OperationKind, x.OperationKey }).IsUnique();
    }
}
