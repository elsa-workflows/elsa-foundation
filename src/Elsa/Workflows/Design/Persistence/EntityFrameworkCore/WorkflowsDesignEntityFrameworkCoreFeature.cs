...
public sealed class WorkflowsDesignEntityFrameworkCoreFeature : IShellFeature
{
    ...
    public void ConfigureServices(IServiceCollection services) => services.AddWorkflowsDesignEntityFrameworkCore(new WorkflowsDesignEntityFrameworkCoreOptions { Provider = Provider, ConnectionString = ConnectionString, ConnectionName = ConnectionName });
}
