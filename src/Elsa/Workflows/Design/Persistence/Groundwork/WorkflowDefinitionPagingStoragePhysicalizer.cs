...
internal static class WorkflowDefinitionPagingStoragePhysicalizer
{
    ...
    private static StorageUnit Physicalize(StorageUnit unit)
    {
        ...
        var definition = PhysicalTableDefinition.PhysicalEntityTable(
            ...
            [
                ...
                Projected(LastModifiedAtColumn, WorkflowsDesignStorageManifest.WorkflowDefinitionLastModifiedAtField, PortablePhysicalType.String),
    ...
    private static ProjectedColumnDefinition Projected(string logicalName, string path, PortablePhysicalType type) =>
        new(
            logicalName,
            path,
            type,
