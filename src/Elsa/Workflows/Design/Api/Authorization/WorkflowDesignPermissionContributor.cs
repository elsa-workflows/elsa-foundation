...
public sealed class WorkflowDesignPermissionContributor : IPermissionContributor
{
    ...
    [
        ...
        new(PermissionNames.WorkflowDesignManage, "Manage workflow designs", "Workflow design", "Create and change workflow definitions.", new HashSet<string> { PermissionNames.WorkflowDesignRead })
    ];
}
