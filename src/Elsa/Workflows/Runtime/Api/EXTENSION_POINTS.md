...
| `ActivityExecutionLayoutReader` | Projects composite-boundary structure from the pinned executable artifact and joins optional source-reference geometry. It never loads Design state and retains authored nodes that did not execute. |
