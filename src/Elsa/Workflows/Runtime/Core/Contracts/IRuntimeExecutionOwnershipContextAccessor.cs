...
/// <summary>
/// Ambient, explicitly-scoped accessor for the current writer's execution ownership lease. Mirrors the push/pop shape
/// of <see cref="IWorkflowExecutionAmbientServicesAccessor"/>: a drain establishes its lease scope for the duration of
/// the drain, and the checkpoint-commit funnel resolves the active lease to fence stale writers out.
/// </summary>
