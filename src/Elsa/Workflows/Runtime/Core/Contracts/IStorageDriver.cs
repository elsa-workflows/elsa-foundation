...
public interface IStorageDriver
{
    ...
    ValueTask WriteAsync(string id, object value, IStorageDriverContext context);
    ...
    ValueTask<object?> ReadAsync(string id, IStorageDriverContext context);
    ...
    /// <param name="context">Context about the workflow execution.</param>
    ValueTask DeleteAsync(string id, IStorageDriverContext context);
}