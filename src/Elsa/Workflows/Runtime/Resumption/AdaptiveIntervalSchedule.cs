...
/// provider, letting the resumption pump widen its interval under sustained failure and snap back once
/// a sweep succeeds. <see cref="ScheduledTaskExecution"/> already re-reads the interval func after each
/// execution, so no extra machinery is needed here.
/// </summary>
