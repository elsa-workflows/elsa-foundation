    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: false),
                    PolicyKey = table.Column<string>(type: "character varying(1244)", maxLength: 1244, nullable: false),
                    PolicyKeyHash = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: false),
                    WorkflowDefinitionId = table.Column<string>(type: "character varying(1200)", maxLength: 1200, nullable: true),
                    WorkflowDefinitionIdHash = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: true),
                    TenantId = table.Column<string>(type: "character varying(1200)", maxLength: 1200, nullable: true),
                    TenantIdHash = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: false),
                    DefaultAction = table.Column<string>(type: "character varying(32)", maxLength: 32, nullable: false),
                    DefaultSlotName = table.Column<string>(type: "character varying(1200)", maxLength: 1200, nullable: false),
                    Revision = table.Column<long>(type: "bigint", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: false),
                    IntentId = table.Column<string>(type: "character varying(1200)", maxLength: 1200, nullable: false),
                    IntentIdHash = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: false),
                    ...
                    ProjectionKind = table.Column<string>(type: "character varying(1200)", maxLength: 1200, nullable: false),
                    ProjectionKindHash = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PreflightToken = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: false),
                    Incarnation = table.Column<string>(type: "character varying(32)", maxLength: 32, nullable: false),
                    ...
                    PolicySource = table.Column<string>(type: "character varying(32)", maxLength: 32, nullable: false),
                    PolicyRevision = table.Column<long>(type: "bigint", nullable: true),
                    RequestedAction = table.Column<string>(type: "character varying(32)", maxLength: 32, nullable: true),
                    RequestedSlotName = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: true),
                    RequestedExpectedPublicationId = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: true),
                    SlotRevision = table.Column<long>(type: "bigint", nullable: false),
                    ActivePublicationId = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: true),
