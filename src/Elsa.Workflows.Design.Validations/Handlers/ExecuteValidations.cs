...
/// <summary>
/// The single <c>OnDraftValidating</c> handler (Sipke's 2026-06-01 one-handler proposal).
...
/// </summary>
public sealed class ExecuteValidations(IEnumerable<IDraftValidator> validators) : IEventHandler<OnDraftValidating>
{
    public async Task Handle(OnDraftValidating domainEvent, CancellationToken cancellationToken)
    {
