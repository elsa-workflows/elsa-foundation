...
/// Distinct from <c>OnActivityPropertyChangedInDraft</c> (per-activity) — workflow-level
...
/// </summary>
public sealed class OnWorkflowOutputAddedToDraft(string draftId, OutputDefinition output) : IDomainEvent
{
