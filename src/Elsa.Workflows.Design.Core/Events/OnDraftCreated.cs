...
/// Unit C FR-018 lifecycle bullet. Sealed class per framework §2.6.1.
/// </summary>
public sealed class OnDraftCreated(string draftId, string workflowDefinitionId) : IDomainEvent
{
