...
/// <c>IAddActivityInputToDraftCommand</c>. Per Unit C FR-018 — activity input full CRUD,
...
/// </remarks>
public sealed class OnActivityInputAddedToDraft(string draftId, string nodeId, ArgumentState input) : IDomainEvent
{
