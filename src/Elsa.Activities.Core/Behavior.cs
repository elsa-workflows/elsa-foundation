...
namespace Elsa.Activities.Core
{
    /// <inheritdoc />
    /// <summary>
    ...
    public abstract class Behavior(IActivity owner) : IBehavior
    {
        ...
        /// </summary>
        public IActivity Owner { get; } = owner;
        ...
        async ValueTask IBehavior.ExecuteAsync(IActivityExecutionContext context) => await ExecuteAsync(context);
    }
}
