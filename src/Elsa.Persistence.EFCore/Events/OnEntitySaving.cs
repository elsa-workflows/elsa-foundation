...
namespace Elsa.Persistence.EFCore.Events
{
    ...
    /// <c>Entity</c>. Handlers participate via <see cref="IDomainEventHandler{TDomainEvent}"/> and
    ...
    /// </summary>
    public sealed record OnEntitySaving(DbContext DbContext, EntityEntry Entry) : IDomainEvent;
}
