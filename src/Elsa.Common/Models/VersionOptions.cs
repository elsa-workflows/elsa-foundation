...
namespace Elsa.Common.Models
{
    ...
    /// </summary>
    /// 
    /// SEE HERE THE CONVERTER ATTRIBUTES; they should not live here, but they need to be here for now to avoid circular dependencies. We should move the converters to a separate assembly and remove these attributes from this class.
