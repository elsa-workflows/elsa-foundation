    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    ScopeKey = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: false),
                    IdOrderKey = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: false),
                    ...
                    ResourceId = table.Column<string>(type: "character varying(512)", maxLength: 512, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ServiceNameKey = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ScopeKey = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: false),
                    Sequence = table.Column<long>(type: "bigint", nullable: false),
                    InstrumentId = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ServiceNameKey = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: false),
                    Status = table.Column<int>(type: "integer", nullable: false),
                    LastSeenTicks = table.Column<long>(type: "bigint", nullable: false),
                    LastSeenOffsetMinutes = table.Column<short>(type: "smallint", nullable: false),
                    PayloadJson = table.Column<string>(type: "text", nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TraceKey = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: false),
                    SpanId = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: false),
                    SpanIdSearchKey = table.Column<string>(type: "text", unicode: false, maxLength: 896, nullable: false),
                    SpanIdOrderKey = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: false),
                    ResourceId = table.Column<string>(type: "character varying(512)", maxLength: 512, nullable: false),
                    ResourceIdSearchKey = table.Column<string>(type: "text", unicode: false, maxLength: 3584, nullable: false),
                    Name = table.Column<string>(type: "text", nullable: false),
                    NameSearchKey = table.Column<string>(type: "text", unicode: false, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "character varying(571)", maxLength: 571, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ValueKey = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: false),
                    Value = table.Column<string>(type: "character varying(512)", maxLength: 512, nullable: false),
                    ValueSearchKey = table.Column<string>(type: "character varying(3584)", maxLength: 3584, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_elsa_otel_spans_ScopeKey_TraceKey_StartTimeTicks_SpanIdOrde~",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_elsa_otel_trace_summary_memberships_ScopeKey_Kind_ValueKey_~",
