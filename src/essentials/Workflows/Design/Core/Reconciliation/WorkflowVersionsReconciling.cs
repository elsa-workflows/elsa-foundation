...
namespace Elsa.Workflows.Design.Core.Reconciliation;
...
/// </remarks>
public sealed class WorkflowVersionsReconciling : IEvent
{
    ...
    /// <see cref="WorkflowVersionsReconciled"/> after a successful pass.
    /// </summary>
