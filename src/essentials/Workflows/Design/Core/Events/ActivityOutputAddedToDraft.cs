...
/// <c>IAddActivityOutputToDraftCommand</c>. Per Unit C FR-018 â€” activity output full CRUD,
/// symmetric with workflow-output CRUD.
/// </summary>
/// <remarks>
/// Distinct from <c>WorkflowOutputAddedToDraft</c>, which adds a workflow-definition-level
/// output declaration. This event is per-activity binding state.
/// </remarks>
public sealed class ActivityOutputAddedToDraft(string draftId, string nodeId, ArgumentState output) : IEvent
{
