...
/// <summary>
/// Lifecycle counterpart to <see cref="DraftValidating"/>. Fires AFTER the validation pass
...
/// <see cref="DraftValidating"/>. <see cref="Errors"/> is the persisted error set —
/// empty if validation found no issues.
/// </para>
/// </remarks>
public sealed class DraftValidated(IWorkflowDefinitionDraft draft, IReadOnlyList<ValidationError> errors) : IEvent
{
