...
public class WorkflowsDesignEntityFrameworkCoreFeature : IShellFeature
{
    ...
    public virtual void ConfigureServices(IServiceCollection services) => services.AddWorkflowsDesignEntityFrameworkCore(new WorkflowsDesignEntityFrameworkCoreOptions { Provider = Provider, ConnectionString = ConnectionString, ConnectionName = ConnectionName, Schema = Schema, Pooling = Pooling })
