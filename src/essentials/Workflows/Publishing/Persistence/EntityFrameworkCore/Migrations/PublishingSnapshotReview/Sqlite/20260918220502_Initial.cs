        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TestRunId = table.Column<string>(type: "TEXT", maxLength: 1200, nullable: false),
                    TestRunIdHash = table.Column<string>(type: "TEXT", maxLength: 64, nullable: false),
                    TestRunIdOrderKey = table.Column<byte[]>(type: "BLOB", maxLength: 902, nullable: false),
                    ReceiptExpiresAtUtcTicks = table.Column<long>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "TEXT", maxLength: 64, nullable: false),
                    ReceiptKeyHash = table.Column<string>(type: "TEXT", maxLength: 64, nullable: false),
                    IdempotencyKey = table.Column<string>(type: "TEXT", maxLength: 1200, nullable: false),
                    ReceiptTenantId = table.Column<string>(type: "TEXT", maxLength: 1200, nullable: true),
                    Status = table.Column<string>(type: "TEXT", maxLength: 32, nullable: false),
                    SchemaVersion = table.Column<string>(type: "TEXT", maxLength: 32, nullable: false),
                    Content = table.Column<string>(type: "TEXT", nullable: false),
                    TenantId = table.Column<string>(type: "TEXT", maxLength: 1200, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PublicationId = table.Column<string>(type: "TEXT", maxLength: 1200, nullable: false),
                    PublicationIdHash = table.Column<string>(type: "TEXT", maxLength: 64, nullable: false),
                    SlotId = table.Column<string>(type: "TEXT", maxLength: 1200, nullable: false),
                    SlotIdHash = table.Column<string>(type: "TEXT", maxLength: 64, nullable: false),
                    SlotName = table.Column<string>(type: "TEXT", maxLength: 1200, nullable: false),
                    WorkflowDefinitionId = table.Column<string>(type: "TEXT", maxLength: 1200, nullable: false),
                    WorkflowDefinitionVersionId = table.Column<string>(type: "TEXT", maxLength: 1200, nullable: false),
                    ArtifactId = table.Column<string>(type: "TEXT", maxLength: 1200, nullable: false),
                    SourceReferenceId = table.Column<string>(type: "TEXT", maxLength: 1200, nullable: true),
                    ExpectedSlotRevision = table.Column<long>(type: "INTEGER", nullable: false),
                    Status = table.Column<string>(type: "TEXT", maxLength: 32, nullable: false),
                    ...
                    ActivatedAtUtcTicks = table.Column<long>(type: "INTEGER", nullable: true),
                    ActivatedAtOffsetMinutes = table.Column<int>(type: "INTEGER", nullable: true),
                    RetiredAtUtcTicks = table.Column<long>(type: "INTEGER", nullable: true),
