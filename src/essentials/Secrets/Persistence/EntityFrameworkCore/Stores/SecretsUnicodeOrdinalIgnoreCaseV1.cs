...
{
    public const string UnicodeVersion = UnicodeOrdinalCasingTable.UnicodeVersion;
    ...
    public static string Project(string value)
    {
        ...
        for (var index = 0; index < value.Length;)
        {
            ...
            result.Append(char.ConvertFromUtf32(UnicodeOrdinalCasingTable.ToSimpleUppercase(scalar)));
        }
