...
/// <summary>
/// One descriptor-consumer contribution behind the transient activity activator.
/// </summary>
public interface IActivityActivationStrategy
{
    string ConsumerKey { get; }

    IReadOnlyCollection<string> SupportedSchemaVersions { get; }

    bool RequiresInputHydration { get; }
...
public sealed record ActivityActivationStrategyRequest(
