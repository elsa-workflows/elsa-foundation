...
public sealed class ActivitiesDesignEntityFrameworkCoreFeature : IShellFeature
{
    ...
    public void ConfigureServices(IServiceCollection services) => services.AddActivitiesDesignEntityFrameworkCore(new() { Provider = Provider, ConnectionString = ConnectionString, ConnectionName = ConnectionName, Schema = Schema, Pooling = Pooling })
