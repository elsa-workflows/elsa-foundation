...
public sealed class GetVersionRequestHandler(IQueries<ActivityDefinitionVersion> queries) : IRequestHandler<GetVersion, ActivityDefinitionVersionDetailsView>
{
