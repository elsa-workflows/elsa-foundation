...
public sealed class ListDefinitionVersionsRequestHandler(IQueries<WorkflowDefinitionVersion> queries)
    : IRequestHandler<ListDefinitionVersions, IEnumerable<WorkflowDefinitionVersionView>>
{
    public async Task<IEnumerable<WorkflowDefinitionVersionView>> Handle(ListDefinitionVersions request, CancellationToken cancellationToken)
    {
