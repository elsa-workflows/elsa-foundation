...
| [147-file-workflow-deployment](../../specs/147-file-workflow-deployment/spec.md) | File-based workflow deployment at startup | Implemented — merged in PR #1161 | - | 38 | 0 | - |
...
| [149-canonical-dependency-map](../../specs/149-canonical-dependency-map/spec.md) | Canonical Dependency Map | Draft | - | 0 | 0 | out of scope |
| [150-package-version-computation](../../specs/150-package-version-computation/spec.md) | Package Version Computation and Selective Publishing | Draft | - | 0 | 0 | out of scope |
...
| [170-ef-payload-compression](../../specs/170-ef-payload-compression/spec.md) | Opt-in Compression for Large EF Payload Columns | Implemented — decoder unit merged as `8e2f388e2` (#1864); the opt-in surface follows in the unit that carries this line | - | 0 | 0 | deferred, out of scope |
| [171-persistence-script-cli](../../specs/171-persistence-script-cli/spec.md) | `dotnet elsa persistence` — Package-Aware Migration SQL for Selected EF Modules | Implemented — slices 1 to 10 merged on 2026-09-20 and 2026-09-21; the optional slice 11 ([#1881](https://github.com/elsa-workflows/elsa-foundation/issues/1881)) delivered 2026-09-22, once the upstream generator change landed as `Elsa.Specifications.PackageManifest.Generator` `0.0.1-preview.8`. The opt-in `--restore` flag ([#1927](https://github.com/elsa-workflows/elsa-foundation/issues/1927), FR-083 to FR-086) landed on 2026-09-22 and settles research item R5; it is an addition to the shipped design, not a change to any of D1 to D13. | - | 0 | 0 | deferred, out of scope |
| [172-engine-capability-declaration](../../specs/172-engine-capability-declaration/spec.md) | The EF Provider Engine Is Declared by the Module and Selected by One Host Key | Implemented — E0 ([#1937](https://github.com/elsa-workflows/elsa-foundation/issues/1937)) merged as [PR 1953](https://github.com/elsa-workflows/elsa-foundation/pull/1953) and E1 ([#1938](https://github.com/elsa-workflows/elsa-foundation/issues/1938)) as [PR 1954](https://github.com/elsa-workflows/elsa-foundation/pull/1954) on 2026-09-22; E2 ([#1939](https://github.com/elsa-workflows/elsa-foundation/issues/1939)) merged in this PR. Upstream: [valence-works/nuplane#77](https://github.com/valence-works/nuplane/issues/77) through its children #87–#90, released as `0.0.11-preview.91`. | - | 0 | 0 | deferred, out of scope |
