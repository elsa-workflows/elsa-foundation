...
| [177-file-deployed-activation](../../specs/177-file-deployed-activation/spec.md) | File-deployed composition activation and recovery | In progress — #2038 adds the file-only candidate handoff (US1); deployment, activation, and recovery (US2/US3) remain unimplemented | - | 10 | 13 | - |
