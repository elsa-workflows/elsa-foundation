...
| [Developer plan, explain, and export #1962](https://github.com/elsa-workflows/elsa-foundation/issues/1962) | Read-only plan command contract [#1999](https://github.com/elsa-workflows/elsa-foundation/issues/1999) active; export/import and live host-check contracts remain separate |
