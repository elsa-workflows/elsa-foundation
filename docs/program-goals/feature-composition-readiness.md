...
2. Use the bounded pure planner delivered in [#1986](https://github.com/elsa-workflows/elsa-foundation/issues/1986) from [spec 174](../../specs/174-profile-selection-planner/spec.md). The [Authoring proof](../reports/runtime-composition/authoring-host-proof.md) found an implicit Runtime API dependency. The [Embedded proof](../reports/runtime-composition/embedded-host-proof.md) ran a useful non-HTTP host but found Runtime API in its feature closure; [#2052](https://github.com/elsa-workflows/elsa-foundation/issues/2052) published the first immutable `embedded-runtime@1` selection through [spec 178](../../specs/178-embedded-runtime-profile/spec.md). [#2066](https://github.com/elsa-workflows/elsa-foundation/issues/2066) published the first flat group, `diagnostics-ef@1`, while keeping its two resource bindings separate. The [Worker proof](../reports/runtime-composition/worker-host-proof.md) exercised authorized HTTP execution and resumption with a named SQLite resource, but completed [identity-boundary spike #2057](../reports/runtime-composition/worker-http-identity-boundary.md) found no shipping external-bearer normalization adapter for Elsa permission policies. Authoring and Worker remain planning fixtures rather than released profiles.
...
| [Runtime builder UX #1963](https://github.com/elsa-workflows/elsa-foundation/issues/1963) | [#2029](https://github.com/elsa-workflows/elsa-foundation/issues/2029) delivered three non-production mocks and an evaluation protocol; [#2064](https://github.com/elsa-workflows/elsa-foundation/issues/2064) prepares and runs real-user evaluation before a production surface is selected |
| [Apply, evolution, and recovery #1964](https://github.com/elsa-workflows/elsa-foundation/issues/1964) | [#2034](https://github.com/elsa-workflows/elsa-foundation/issues/2034) documented the saved-versus-active failure boundary; [#2036](https://github.com/elsa-workflows/elsa-foundation/issues/2036) specified the file-deployed default-shell flow; [#2038](https://github.com/elsa-workflows/elsa-foundation/issues/2038) delivered the file-only safe handoff. [#2039](https://github.com/elsa-workflows/elsa-foundation/issues/2039) found no exact-candidate marker in the current host path; [#2041](https://github.com/elsa-workflows/elsa-foundation/issues/2041) delivered safe default-shell generation/readiness observation with candidate match unverified. [#2042](https://github.com/elsa-workflows/elsa-foundation/issues/2042) found a conditional CShells seam, and [#2046](https://github.com/elsa-workflows/elsa-foundation/issues/2046) ruled out complete Workbench hot-reload attribution. [#2060](https://github.com/elsa-workflows/elsa-foundation/issues/2060) established a conditional fresh-process file boundary but no source/override attestation; [#2062](https://github.com/elsa-workflows/elsa-foundation/issues/2062) adds process identity to safe default-shell observations. [#2068](../reports/runtime-composition/deployment-source-receipt-boundary.md) shows test-owned deployer refusal but no host-produced source receipt; [#2070](../reports/runtime-composition/workbench-startup-context.md) identifies the live root/shell split; [#2072](../reports/runtime-composition/workbench-retained-startup-lane.md) proves an opt-in declared-artifact lane but leaves early host and later DI consumers outside the claim. Candidate match remains unverified. |
...
- [Worker HTTP identity-boundary investigation](../reports/runtime-composition/worker-http-identity-boundary.md)
...
- [Workbench restart-scoped source boundary](../reports/runtime-composition/workbench-restart-snapshot.md)
- [Deployer-to-Workbench source receipt boundary](../reports/runtime-composition/deployment-source-receipt-boundary.md)
- [Workbench-owned startup context boundary](../reports/runtime-composition/workbench-startup-context.md)
- [Retained startup lane proof](../reports/runtime-composition/workbench-retained-startup-lane.md)
