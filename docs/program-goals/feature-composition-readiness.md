...
| [Apply, evolution, and recovery #1964](https://github.com/elsa-workflows/elsa-foundation/issues/1964) | [#2034](https://github.com/elsa-workflows/elsa-foundation/issues/2034) documented the saved-versus-active failure boundary; [#2036](https://github.com/elsa-workflows/elsa-foundation/issues/2036) specifies the file-deployed default-shell flow; [#2038](https://github.com/elsa-workflows/elsa-foundation/issues/2038) adds the file-only safe handoff. Host attestation [#2039](https://github.com/elsa-workflows/elsa-foundation/issues/2039) still gates any verified activation claim |
