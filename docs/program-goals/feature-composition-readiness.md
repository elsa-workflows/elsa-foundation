...
2. Use the bounded pure planner delivered in [#1986](https://github.com/elsa-workflows/elsa-foundation/issues/1986) from [spec 174](../../specs/174-profile-selection-planner/spec.md). [#1991](https://github.com/elsa-workflows/elsa-foundation/issues/1991) now tests the Authoring planning fixture against a rebuilt host. Treat candidate examples as planning fixtures until their host behavior is proven.
...
| [Profiles and feature groups #1961](https://github.com/elsa-workflows/elsa-foundation/issues/1961) | Catalog decision [#1982](https://github.com/elsa-workflows/elsa-foundation/issues/1982), planner specification [#1984](https://github.com/elsa-workflows/elsa-foundation/issues/1984), and pure planner [#1986](https://github.com/elsa-workflows/elsa-foundation/issues/1986) delivered; [Authoring host-evidence spike #1991](https://github.com/elsa-workflows/elsa-foundation/issues/1991) active before any live profile is released |
