...
| [Apply, evolution, and recovery #1964](https://github.com/elsa-workflows/elsa-foundation/issues/1964) | [#2034](https://github.com/elsa-workflows/elsa-foundation/issues/2034) investigates the first file/deployment activation and recovery boundary; no production apply contract is delivered |
