...
2. Specify deterministic selection planning from the [#1982 decision record](../reports/runtime-composition/profile-catalog-contract.md) in [#1984](https://github.com/elsa-workflows/elsa-foundation/issues/1984). Treat candidate examples as planning fixtures until their host behavior is proven; file a pure-planner implementation story only after its contract is reviewed.
...
| [Profiles and feature groups #1961](https://github.com/elsa-workflows/elsa-foundation/issues/1961) | Catalog/profile decision recorded in [#1982](https://github.com/elsa-workflows/elsa-foundation/issues/1982); planner specification active in [#1984](https://github.com/elsa-workflows/elsa-foundation/issues/1984) |
