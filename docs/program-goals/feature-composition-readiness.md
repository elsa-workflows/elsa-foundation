...
| [Developer plan, explain, and export #1962](https://github.com/elsa-workflows/elsa-foundation/issues/1962) | Read-only plan command contract [#1999](https://github.com/elsa-workflows/elsa-foundation/issues/1999) and offline command [#2001](https://github.com/elsa-workflows/elsa-foundation/issues/2001) delivered; selected-host evidence boundary [#2003](https://github.com/elsa-workflows/elsa-foundation/issues/2003) documented; import/export contract boundary [#2005](https://github.com/elsa-workflows/elsa-foundation/issues/2005) led to draft file-bridge spec [#2009](https://github.com/elsa-workflows/elsa-foundation/issues/2009); live host-check remains separate |
