...
6. Complete four-provider runtime-alteration store evidence for the additive 35th Groundwork
   coverage-ledger row without mutating the immutable all-34 composition artifact. Superseded:
   Groundwork and its coverage ledger were deleted by #1764, and the alteration plan and job stores
   are EF Core since #1744 (storage-unit register R11-R12).
