...
| [EF Core Persistence](ef-core-persistence.md) | Active | Elsa persistence-family consolidation / four-provider EF Core delivery | Sipke plus the EF Core persistence control room | Record ADR 0073 and the verified ledger, then resolve the four architecture spikes before broad implementation |
