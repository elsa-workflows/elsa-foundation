...
| [EF Core Persistence](ef-core-persistence.md) | Active | Elsa persistence-family consolidation / four-provider EF Core delivery | Sipke plus the EF Core persistence control room | Complete #1671's entry-level inventory, then resolve the four architecture spikes before broad implementation |
