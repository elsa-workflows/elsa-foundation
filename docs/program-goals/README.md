...
| [BPMN Engine](bpmn-engine.md) | Active | Executable BPMN 2.0 engine + interchange + the runtime seams it consumes | Sipke plus the BPMN control-room session | Phase 3: specs 123–128 + 132 (#989 fix, error event subprocesses live) merged; next call activity, then tier-2 event subprocesses / collaborations |
