...
| [Zero-EF Persistence](zero-ef-persistence.md) | Superseded | Historical Elsa persistence-provider consolidation / Groundwork adoption | Sipke plus active architects/agents | Retained for provenance; accepted ADR 0072 governs the bounded EF relational lane and keeps rollout at `none/free-flow` |
