...
| [BPMN Engine](bpmn-engine.md) | Active | Executable BPMN 2.0 engine + interchange + the runtime seams it consumes | Sipke plus the BPMN control-room session | Phase 3: specs 123–128, 132–135 merged (message send surface live); remaining: collaboration/pool import (final slice) |
