...
**Output:** prioritized list of next candidates, with whether each is architecture, docs, tests, or code, the program goal state used for ranking, and any completed short-term objective that was removed or superseded.
