...
| `FaultWorkflow` keeps the incident blocking and faults the workflow; `ContinueWithIncidents` opens it and does not | `src/Elsa/Workflows/Runtime/Services/Incidents/IncidentResolutionActions.cs` |
