...
| S6 Input bindings, activity results, and causal projection resolution | Superseded by spec 095 | `RuntimeInputBinding`, `ActivityCompletion`, `ActivityResultProjectionContract`, `ICausalActivityResultResolver` |
