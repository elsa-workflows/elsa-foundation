...
| Diagnostics | `GroundworkOpenTelemetryStore`, `GroundworkStructuredLogStore`, opt-in EF `StructuredLogs` adapter | O01-O09 | #1681/#1695; S1-S3 | E-OBS | | | | Structured Logs EF is tracked by #1695 and pending merge; Groundwork remains default and OpenTelemetry/default-flip/deletion gates remain pending |
...
| O09 | `elsa-structured-logs` / `elsa_structured_logs` | Structured-log store; append, replay/high-water and retention | E-OBS | S1-S3; #1695 | | | | Opt-in EF implementation tracked by #1695 is pending merge; Groundwork/default flip/deletion deferred |
