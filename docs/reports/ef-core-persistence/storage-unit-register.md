...
| ID | Groundwork unit / physical name | Domain contract or semantic role | Evidence | Blockers | Replacement PR | Default-flip PR | Deletion PR | Disposition |
|---|---|---|---|---|---|---|---|---|
| W01 | `workflowDefinition` / `elsa_workflow_definitions_v2` | `IWorkflowDefinitionStore`; definition read authority | E-DESIGN | S1-S3 | #1727 (opt-in EF) | | | Opt-in EF implementation committed; default flip and deletion pending |
| W02 | `workflowDefinitionVersion` / `elsa_workflow_definition_versions` | `IWorkflowDefinitionVersionStore` | E-DESIGN | S1-S3 | #1727 (opt-in EF) | | | Opt-in EF implementation committed; default flip and deletion pending |
| W03 | `workflowDefinitionDraft` / `elsa_workflow_definition_drafts` | `IWorkflowDefinitionDraftStore` and draft commands | E-DESIGN | S1-S3 | #1727 (opt-in EF) | | | Opt-in EF implementation committed; default flip and deletion pending |
| W04 | `workflowDefinitionVersionLayout` / `elsa_workflow_definition_version_layouts` | `IWorkflowDefinitionVersionLayoutStore` | E-DESIGN | S1-S3 | #1727 (opt-in EF) | | | Opt-in EF implementation committed; default flip and deletion pending |
| W05 | `workflowDesignOperation` / `elsa_design_operations` | Idempotent design-operation ledger and atomic commands | E-CLAIM | S1-S3 | #1727 (opt-in EF) | | | Opt-in EF implementation committed; default flip and deletion pending |
