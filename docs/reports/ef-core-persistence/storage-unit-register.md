...
| Diagnostics | `GroundworkOpenTelemetryStore`, `GroundworkStructuredLogStore` | O01-O09 | #1681; S1-S3 | E-OBS | | | | Pending |
| Secrets | `GroundworkSecretRepository` | S01 | #1679; S1/S3 | E-CRUD | | | | Pending |
| Studio Preferences | `GroundworkStudioPreferenceStore` | U01 | #1680; S1/S3 | E-CRUD | | | | Pending |
...
| O09 | `elsa-structured-logs` / `elsa_structured_logs` | Structured-log store; append, replay/high-water and retention | E-OBS | S1-S3 | | | | Pending |
...
| U01 | `elsa-studio-preferences` / `elsa_studio_preferences` | `IStudioPreferenceStore` | #1680 | E-CRUD plus scope and last-write semantics | S1, S3 | | | | Pending |
