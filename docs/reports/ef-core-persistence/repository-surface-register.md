...
| H22 | `src/Elsa/Workflows/Runtime/Persistence/EntityFrameworkCore/**` and its focused tests | #1723/#1725 | Provider-neutral EF Core + Relational R01 bookmark state plus R02-R06 executable artifact, retention-coordination, template/hash-claim, and source-reference implementation; exact scoped identity, lossless projections, CAS save/delete, leases/fencing, bounded ordinal keyset paging, authenticated continuations, rollback/restart, DI ownership, and provider model/smoke proof; no migrations in this slice | | | | R01 and R02-R06 implementations and focused proof are prepared under #1723/#1725; R02-R06 are fresh-schema-only with comprehensive SQLite proof and representative SQL Server/MySQL proof; PostgreSQL artifact proof passed but bookmark proof remains unverified after local container failures; migration/default-flip/deletion gates remain pending; Groundwork remains default |
