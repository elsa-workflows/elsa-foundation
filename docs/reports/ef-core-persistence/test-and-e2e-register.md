...
| T61 | `tests/Elsa/Workflows/Runtime/Distributed/Persistence/EntityFrameworkCore/Tests/Elsa.Workflows.Runtime.Distributed.Persistence.EntityFrameworkCore.Tests.csproj` | #1717 | SQLite placement behavior: scope/identity losslessness, claim/renew/takeover/release/list, rollback/tracker recovery, concurrency, restart, invalid input/cancellation and opt-in registration | SQLite; EF D01 replacement implementation in #1717 | | |
