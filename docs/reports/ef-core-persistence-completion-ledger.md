...
| P08 | `src/Elsa/Persistence/Groundwork/V2/Elsa.Persistence.Groundwork.V2.csproj` | Shared Groundwork policy plus 29 Runtime units | #1672; proving slice #1676; R01 task #1723; R02-R06 task #1725 | All four spikes; Runtime proving slice | Checkpoint atomicity, marker reconciliation, leases/fencing, queues, timers, dispatch/outbox, recovery, contention | | | | R01 and R02-R06 EF replacements are prepared under #1723/#1725; R02-R06 are fresh-schema-only with comprehensive SQLite proof and representative SQL Server/MySQL proof; PostgreSQL artifact proof passed but bookmark proof remains unverified after local container failures; migration lifecycle, default flip, and R07-R29 remain pending; Groundwork remains default |
