...
| P08 | `src/Elsa/Persistence/Groundwork/V2/Elsa.Persistence.Groundwork.V2.csproj` | Shared Groundwork policy plus 29 Runtime units | #1672; proving slice #1676; R01 task #1723; R02-R06 task #1725 | All four spikes; Runtime proving slice | Checkpoint atomicity, marker reconciliation, leases/fencing, queues, timers, dispatch/outbox, recovery, contention | | | | R01 and R02-R06 EF replacements are prepared under #1723/#1725; R02-R06 are fresh-schema-only with comprehensive SQLite proof and exact local native smoke green 6/6 across PostgreSQL/SQL Server/MySQL bookmark and artifact suites, including PostgreSQL bookmark; broader provider matrices and hosted required-provider gating, migration lifecycle, default flip, and R07-R29 remain pending; Groundwork remains default |
| P09 | `src/Elsa/Workflows/Runtime/Distributed/Persistence/Groundwork/Elsa.Workflows.Runtime.Distributed.Persistence.Groundwork.csproj` | 3 units: placement, command-stream head, command transport | #1672; proving slice #1676; D02-D03 task #1720 | Runtime proving slice and transaction topology | Placement ownership/fencing; atomic stream-head + command write; redelivery, crash/restart | #1718 (D01); #1721 (D02-D03 task #1720) | | | D01-D03 EF replacements are merged and Groundwork remains default |
