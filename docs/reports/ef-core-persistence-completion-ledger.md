...
| P08 | `src/Elsa/Persistence/Groundwork/V2/Elsa.Persistence.Groundwork.V2.csproj` | Shared Groundwork policy plus 29 Runtime units | #1672; proving slice #1676; R01 task #1723 | All four spikes; Runtime proving slice | Checkpoint atomicity, marker reconciliation, leases/fencing, queues, timers, dispatch/outbox, recovery, contention | | | | R01 EF replacement is prepared under #1723; R02-R29 remain pending and Groundwork remains default |
