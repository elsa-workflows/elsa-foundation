...
The drift guard is lightweight and the default program-goal bucket is clear. The risk is not missing process; the risk is agents continuing local cleanup work because it is nearby.
