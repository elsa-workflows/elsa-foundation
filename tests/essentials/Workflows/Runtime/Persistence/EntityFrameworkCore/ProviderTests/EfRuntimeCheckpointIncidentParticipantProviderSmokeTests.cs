...
internal static class RuntimeCheckpointIncidentParticipantProviderSmoke
{
    ...
    private static EfIncidentStateStore Store(RuntimeDbContext context, string scope) =>
        ...
        string workflowExecutionId)
    {
        ...
        var method = type.GetMethod("StageIncidentsAsync", BindingFlags.Public | BindingFlags.Static)!;
        try
        {
