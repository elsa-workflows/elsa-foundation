...
{
    private const string OwningCatalog = "src/essentials/Diagnostics/Persistence/EXTENSION_POINTS.md";
    ...
    /// </summary>
    [Theory]
    [InlineData("src/essentials/Diagnostics/Persistence/Draining/DiagnosticsDrainContracts.cs")]
    [InlineData("src/essentials/Diagnostics/Persistence/Observability/DiagnosticsPersistenceObservability.cs")]
