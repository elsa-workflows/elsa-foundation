...
public sealed class PermissionAuthorizationBoundaryTests
{
    ...
    public void Transport_authorization_contexts_are_not_allowed_to_read_permission_claims_directly()
    {
        using var fixture = new TemporaryDirectory();
        fixture.Write(
            "src/essentials/Foundation/Identity/Api/Endpoints/Token.cs",
            PermissionClaimProjectionFixture);
        fixture.Write(
            "src/essentials/Activities/Design/Api/Services/HttpContextActivityDesignAuthorizationContext.cs",
            PermissionClaimProjectionFixture);
        fixture.Write(
            "src/essentials/Workflows/Runtime/Api/Services/HttpContextActivityExecutionInspectionAuthorizationContext.cs",
            PermissionClaimProjectionFixture);
    ...
    {
        {
            "src/essentials/Api/FastEndpoints/Abstractions/InjectedPermissions.cs",
            """
        ...
        {
            "src/essentials/Api/FastEndpoints/Abstractions/InjectedPermissionsAll.cs",
            """
            namespace FastEndpoints;
        ...
        {
            "src/essentials/Api/Capabilities/Endpoints/InjectedFindFirst.cs",
            """
            using System.Security.Claims;
        ...
        {
            "src/essentials/Api/Capabilities/Endpoints/InjectedFindFirstValue.cs",
            """
            using System.Security.Claims;
        ...
        {
            "src/essentials/Api/Capabilities/Endpoints/InjectedFindAll.cs",
            """
            using System.Security.Claims;
            using System.Linq;
        ...
        {
            "src/essentials/Api/Capabilities/Endpoints/InjectedHasClaim.cs",
            """
            using System.Security.Claims;
        ...
        {
            "src/essentials/Api/Capabilities/Endpoints/InjectedClaimsAny.cs",
            """
            using System.Linq;
            using System.Security.Claims;
        ...
        {
            "src/essentials/Api/Capabilities/Endpoints/InjectedAlias.cs",
            """
            using System.Linq;
            using System.Security.Claims;
        ...
        {
            "src/essentials/Api/Capabilities/Endpoints/InjectedProviderPermissionConstant.cs",
            """
            using System.Security.Claims;
...
internal static class PermissionAuthorizationBoundaryScanner
{
    ...
    private static readonly ImmutableHashSet<string> ReviewedAllowlist =
        ImmutableHashSet.Create(
            ...
            "src/essentials/Foundation/Identity/Authorization/AuthorizationServices.cs",
            "src/essentials/Foundation/Identity/Api/Endpoints/Token.cs",
            "src/essentials/Foundation/Identity/Api/Services/ClaimsAuthSessionService.cs",
            "src/essentials/Foundation/Identity/AspNetCoreIdentity/Services/DefaultAuthSessionService.cs",
            "src/essentials/Foundation/Identity/AspNetCoreIdentity/Services/IdentityClaimsProjector.cs",
            "src/essentials/Foundation/Identity/OpenIddict/Behavior/OpenIddictTokenService.cs");
    ...
    {
        var sourceRoot = Path.Join(repositoryRoot, "src", "essentials");
    ...
    private static bool IsBoundaryPath(string relativePath) =>
        relativePath.StartsWith("src/essentials/Api/FastEndpoints/Abstractions/", StringComparison.Ordinal) ||
