...
public sealed class ReusableActivityArchitectureTests
{
    ...
    public void New_reusable_activity_surface_does_not_reference_legacy_workflow_as_activity_types()
    {
        string[] roots =
        [
            "src/essentials/Activities/Graph",
            "src/essentials/Workflows/Publishing/Persistence/EntityFrameworkCore",
    ...
    {
        // Both module roots: required modules stay under src/, optional ones live under src/extensions/ (#1815).
        ...
        Assert.All(hits, file => Assert.StartsWith("src/extensions/Elsa3/src/", file, StringComparison.Ordinal));
    ...
    public void Runtime_activity_activation_uses_stable_wire_identity_only()
    {
        var descriptor = File.ReadAllText(FullPath(
            "src/essentials/Activities/Runtime/Core/Models/RuntimeActivityDescriptor.cs"));
        var activationStrategy = File.ReadAllText(FullPath(
            "src/essentials/Activities/Runtime/Core/Contracts/IActivityActivationStrategy.cs"));
        var activator = File.ReadAllText(FullPath(
            "src/essentials/Activities/Runtime/Contracts/IActivityActivator.cs"));
        var executableNode = File.ReadAllText(FullPath(
            "src/essentials/Workflows/Runtime/Core/Models/ExecutableNode.cs"));
    ...
    public void Universal_activity_version_contracts_do_not_expose_clr_descriptor_type_identity()
    {
        ...
        [
            "src/essentials/Activities/Design/Core/Contracts/IActivityDefinitionVersion.cs",
            "src/essentials/Activities/Design/Core/Models/ActivityDefinitionVersionModel.cs",
            "src/essentials/Activities/Design/Core/Reconciliation/Models/ActivityVersionReconciliationModel.cs",
            "src/essentials/Activities/Design/Api/Commands/AddDefinition.cs",
            "src/essentials/Activities/Design/Api/Commands/AddVersion.cs",
            "src/essentials/Activities/Design/Api/Models/ActivityDefinitionVersionDetailsView.cs"
        ];
