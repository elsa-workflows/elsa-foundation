...
public sealed class WorkflowPortfolioProviderMongoDbTests(MongoDbDashboardContainerFixture fixture)
{
    private static readonly DateTimeOffset Now = new(2026, 7, 13, 12, 0, 0, TimeSpan.Zero);
    private static readonly FakePayloadSerializer PayloadSerializer = new();

    [SkippableFact]
    public async Task GroundworkMongoDbReturnsTheCompleteIdenticalPortfolioFixture()
    {
        ...
        var source = new MongoDbWorkflowPortfolioDataSource(() => fixture.Driver.CreateRawDatabase(), PayloadSerializer);
