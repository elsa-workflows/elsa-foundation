...
{
    [Fact]
    public void Maps_eight_query_and_stream_routes_with_owner_metadata()
    {
        ...
        Assert.Equal(8, routes.Select(route => route.RoutePattern.RawText).Distinct(StringComparer.Ordinal).Count());
