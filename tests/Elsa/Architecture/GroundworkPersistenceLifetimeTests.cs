...
public sealed class GroundworkPersistenceLifetimeTests
{
    ...
    [
        ...
        new("src/Elsa/Workflows/Publishing/Publishing/WorkflowsPublishingFeature.cs", "IPublicationProjectionPreparer"),
        new("src/Elsa/Workflows/Publishing/Publishing/WorkflowsPublishingFeature.cs", "IPublicationActivator"),
        new("src/Elsa/Workflows/Publishing/Publishing/WorkflowsPublishingFeature.cs", "PublicationSnapshotReviewService"),
