...
public sealed class EfCoreWorkflowDesignQueryContractSuite : WorkflowDesignQueryContractSuite
{
    protected override async Task<IDesignPersistenceContractFixture> CreateFixtureAsync(CancellationToken cancellationToken = default) =>
        await EfCoreDesignPersistenceContractFixture.CreateAsync(cancellationToken);
}

public sealed class EfCoreActivityDesignQueryContractSuite : ActivityDesignQueryContractSuite
{
    protected override async Task<IDesignPersistenceContractFixture> CreateFixtureAsync(CancellationToken cancellationToken = default) =>
        await EfCoreDesignPersistenceContractFixture.CreateAsync(cancellationToken);
}

public sealed class EfCoreDesignQueryScaleContractSuite : DesignQueryScaleContractSuite
{
