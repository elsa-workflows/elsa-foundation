...
public sealed class GroundworkTargetBaselineTests
{
    ...
    private const string CurrentGroundworkVersion = "0.0.1-preview.94";
    ...
    public async Task Target_profile_matches_the_ratified_twenty_five_green_baseline()
    {
        ...
        // preview.94 plus the durable runtime-alteration schema retains unaccepted physical target and plan
    ...
    private static void WriteEvidenceIfRequested(BaselineEvidence evidence)
    {
            ...
            evidence.PlanFingerprint != AcceptedPlanFingerprint)
        {
            throw new InvalidOperationException(
                "The preview.94 target/plan fingerprint drift is captured but not accepted for evidence publication. " +
