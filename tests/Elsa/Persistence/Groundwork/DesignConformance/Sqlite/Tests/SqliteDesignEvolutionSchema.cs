...
/// </summary>
internal static class SqliteDesignEvolutionSources
{
...
public sealed class SqliteDesignEvolutionDeploymentSchema : GroundworkDeploymentSchemaManifestSource
{
    protected override IReadOnlyCollection<Type> ManifestSourceTypes =>
        [.. SqliteDesignEvolutionSources.Baseline, typeof(DesignEvolutionProbeGroundworkStorageManifestSource)];
}
...
/// </summary>
public sealed class SqliteDesignEvolutionCollisionDeploymentSchema : GroundworkDeploymentSchemaManifestSource
{
    protected override IReadOnlyCollection<Type> ManifestSourceTypes =>
        [.. SqliteDesignEvolutionSources.Baseline, typeof(DesignEvolutionCollisionGroundworkStorageManifestSource)];
}
