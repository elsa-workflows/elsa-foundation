...
/// </summary>
internal static class SqlServerDesignEvolutionSources
{
...
public sealed class SqlServerDesignEvolutionDeploymentSchema : GroundworkDeploymentSchemaManifestSource
{
    protected override IReadOnlyCollection<Type> ManifestSourceTypes =>
        [.. SqlServerDesignEvolutionSources.Baseline, typeof(DesignEvolutionProbeGroundworkStorageManifestSource)];
}
...
/// </summary>
public sealed class SqlServerDesignEvolutionCollisionDeploymentSchema : GroundworkDeploymentSchemaManifestSource
{
    protected override IReadOnlyCollection<Type> ManifestSourceTypes =>
        [.. SqlServerDesignEvolutionSources.Baseline, typeof(DesignEvolutionCollisionGroundworkStorageManifestSource)];
}
