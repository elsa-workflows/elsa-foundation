...
/// whereas the Spec 094 ledger currently requires preview.72 evidence.
/// </summary>
public sealed class IamSecretsProviderEvidencePublicationTests
{
    ...
    [Fact]
    public void Preview60_identity_authority_artifacts_cannot_satisfy_the_preview71_B6_ledger()
    {
        ...
        Assert.Equal("0.0.1-preview.72", ledgerVersion);
