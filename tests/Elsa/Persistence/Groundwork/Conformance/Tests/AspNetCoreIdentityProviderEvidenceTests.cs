...
public sealed class AspNetCoreIdentityProviderEvidenceTests
{
    ...
    private const string CurrentGroundworkVersion = "0.0.1-preview.64";
    ...
    public void Generate_all_preview60_provider_artifacts_only_after_the_complete_matrix_passes()
    {
        Skip.If(
            ...
            "Generate preview.64 evidence only in a dedicated evidence-regeneration work unit with a matching schema.");
    }
