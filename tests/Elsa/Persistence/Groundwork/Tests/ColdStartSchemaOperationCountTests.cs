...
public sealed class ColdStartSchemaOperationCountTests(ITestOutputHelper output)
{
    ...
    // 2026-08-17: the transitional v1 reference target excludes the independently admitted v2 distributed units.
    // Legacy diagnostics, Secrets, and Studio persistence are deliberately not folded into
    // this v1 document target; their Groundwork v2 adapters own independent units and admission.
    private const int ExpectedFreshDatabaseOperationCount = 898;
