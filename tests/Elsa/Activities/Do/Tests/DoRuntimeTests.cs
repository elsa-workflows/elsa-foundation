...
public sealed class DoRuntimeTests
{
    ...
    private static WorkflowExecutionHarness NewHarness(int holdEvaluations, params string[] activityExecutionIds) =>
        WorkflowExecutionHarness.Create()
            .WithFeature(services => new ActivitiesDoFeature().ConfigureServices(services))
    ...
    private static WorkflowExecutable NewExecutable()
    {
        var root = new ExecutableNode(
            ...
            childSlots: [new ExecutableChildSlot(DoActivity.BodySlotName, [WorkflowExecutionHarness.NewProbeNode("node-body")])],
