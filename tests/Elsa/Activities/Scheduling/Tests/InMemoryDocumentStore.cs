...
// Test double standing in for a second Groundwork provider. It implements the same provider-neutral
// IDocumentStore contract the relational/document providers implement and resolves query index
// name -> declared field path from the manifest, exactly like the real providers. Used to prove the
// bridge behaves identically regardless of which provider the host selects.
