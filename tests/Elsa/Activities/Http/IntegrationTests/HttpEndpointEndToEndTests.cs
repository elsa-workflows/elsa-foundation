...
public sealed class HttpEndpointEndToEndTests : IAsyncLifetime
{
    ...
    public async Task MatchingRequest_StartsWorkflow_RepliesAccepted_AndTheRunObservesTheLiveRequest()
    {
        ...
        var captured = await _fixture.ReadResultProjectionAsync(workflowExecutionId, ResultOutputName);
    ...
    public async Task JsonBody_DerivesParsedContentOutput_AndKeepsTheRawBodyOnTheResult()
    {
        ...
        var capturedResult = await _fixture.ReadResultProjectionAsync(workflowExecutionId, ResultOutputName);
        ...
        var capturedParsed = await _fixture.ReadResultProjectionAsync(workflowExecutionId, HttpEndpointHostFixture.ParsedContentOutputName);
