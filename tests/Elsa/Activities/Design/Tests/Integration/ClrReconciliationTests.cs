...
public sealed class ClrReconciliationTests
{
    ...
    public async Task FolderSource_ReconcilesAuthorControlledVersions_AndIsIdempotent()
    {
        ...
        // The fixture assembly carries fourteen concrete activities, including the typed result fixture,
        // the C# required-member fixture, three input-options fixtures, and two outcome-attribute
        // fixtures (abstract bases are excluded).
        Assert.Equal(14, store.Versions.Count);
    ...
    public async Task BumpedVersion_AppendsNewRow_RetainingTheOldOne()
    {
        ...
        // First pass via the real CLR source persists all fourteen concrete fixture activities.
