...
public sealed class RuntimeRecurringScheduleSelectionWorkloadTests
{
    ...
    private sealed class RecurringScheduleBacking
    {
        ...
        public List<RecurringTriggerScheduleActivationPageQuery> PublicationPageRequests { get; } = [];
    ...
    private sealed class AtomicRecurringScheduleStore(RecurringScheduleBacking backing, RecurringScheduleAdapterFault fault) : IRecurringTriggerScheduleStore
    {
        ...
        public ValueTask PrepareActivationAsync(string activationId, IReadOnlyCollection<RecurringTriggerSchedule> schedules, CancellationToken cancellationToken = default)
        {
            ...
            lock (backing.Sync)
            {
                ...
                backing.PreparedPublications.Add(activationId);
        ...
        public ValueTask ActivateAsync(string activationId, string? replacedActivationId, CancellationToken cancellationToken = default)
        {
            ...
            lock (backing.Sync)
            {
                if (!backing.PreparedPublications.Contains(activationId))
