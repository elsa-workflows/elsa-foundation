...
binaries or connection strings. The runner generates it automatically; an operator-supplied `--composition` is
optional and, when present, is an expected-value check.
