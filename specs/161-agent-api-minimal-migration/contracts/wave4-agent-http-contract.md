...
| ApproveProposal | `POST /_elsa/agent/proposals/{proposalId}/approve` | `agent.proposals` |
| DenyProposal | `POST /_elsa/agent/proposals/{proposalId}/deny` | `agent.proposals` |
| ExecuteProposal | `POST /_elsa/agent/proposals/{proposalId}/execute` | `agent.proposals` |
