...
- [X] T013 Implement in-memory dispatch storage and atomic checkpoint projection/replay validation in `src/Elsa/Workflows/Runtime/Services/Dispatch/InMemoryWorkflowDispatchStore.cs` and `src/Elsa/Workflows/Runtime/Services/Checkpoints/InMemoryRuntimeCheckpointCommitStore.cs`
