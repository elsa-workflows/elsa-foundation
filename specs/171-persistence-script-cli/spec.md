...
All four shipped together in `0.0.11-preview.83`; Elsa still pins `0.0.9-preview.61`; the pin bump is tracked by [#1893](https://github.com/elsa-workflows/elsa-foundation/issues/1893).
...
- Nuplane's `HostIntegrated` load mode and `store-state.json` format are a stable enough contract for the worker to depend on. U1–U4 were implemented, merged, and published to `main` (`e93ad89`) as `0.0.11-preview.83` on 2026-09-20; Elsa still pins `0.0.9-preview.61`, and the one remaining step before the Elsa slices that depend on them can start is the `Directory.Packages.props` pin bump ([#1893](https://github.com/elsa-workflows/elsa-foundation/issues/1893)).
...
- **N1 ([valence-works/nuplane#73](https://github.com/valence-works/nuplane/issues/73)) and N2 ([valence-works/nuplane#74](https://github.com/valence-works/nuplane/issues/74)) were delivered 2026-09-20.** What now gates Elsa slice 4 ([#1874](https://github.com/elsa-workflows/elsa-foundation/issues/1874)) for Nuplane hosts is not a Nuplane release any more — it is the Elsa `Directory.Packages.props` pin bump ([#1893](https://github.com/elsa-workflows/elsa-foundation/issues/1893)).
- **N3 ([valence-works/nuplane#75](https://github.com/valence-works/nuplane/issues/75)) was delivered 2026-09-20.** What now gates the defense half of Elsa slice 10 ([#1880](https://github.com/elsa-workflows/elsa-foundation/issues/1880)) is the same pin bump ([#1893](https://github.com/elsa-workflows/elsa-foundation/issues/1893)); the required Elsa `IFeatureActivationGuard` half still depends on nothing.
...
- **One Elsa `Directory.Packages.props` pin bump** — `0.0.9-preview.61` → `0.0.11-preview.83`, tracked by [#1893](https://github.com/elsa-workflows/elsa-foundation/issues/1893) — replaces the previous "every Nuplane slice needs a release" rule.
