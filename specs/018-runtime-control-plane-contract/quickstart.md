# Quickstart: Runtime Control Plane Contract
...
```bash
rg -n "ControlPlane|PauseWorkflowExecution|UnpauseWorkflowExecution|ResumeBookmark|ContinueVolatileWait" src/Elsa/Workflows/Runtime/Core tests/Elsa/Workflows/Runtime/Tests
```
