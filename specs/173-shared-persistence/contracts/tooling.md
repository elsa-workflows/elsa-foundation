...
Status: Phase 1 design for #1967; pending integrated review. The new API and flags below require #1968 implementation. Legacy protocol and manifest version 1 remain unchanged.
