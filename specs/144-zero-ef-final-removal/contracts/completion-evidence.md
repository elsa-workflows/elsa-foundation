...
- #642 diagnostics merge SHA, four-provider conformance, grouped-reducer evidence, test-retention ledger, and accepted diagnostics performance verdict
...
- Ratified targeted constitution amendment identity and version

### Independent review

Three exact-range records:

1. correctness/mechanism;
2. evidence integrity;
3. scope and test preservation.

Every confirmed finding includes its fix and originating-reviewer re-verification.
...
- any prerequisite evidence exists only on an unmerged branch;
- an EF category is nonempty;
- any repository project lacks restore assets;
- a performance verdict is missing, blocked, or inferred from correctness alone;
- a required provider composition omits a feature;
