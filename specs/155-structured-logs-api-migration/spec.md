...
- **FR-016**: Anonymous callers and identities rejected by principal normalization MUST receive an authentication challenge; authenticated callers without permission MUST be forbidden before any query or stream starts.
