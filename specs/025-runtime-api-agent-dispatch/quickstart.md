# Quickstart: Runtime API Agent Dispatch
...
Expected result: Runtime API execute requests produce workflow execution start dispatch responses and do not execute activities inline.
