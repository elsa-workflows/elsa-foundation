...
5. **Amended generic materialized-source lifecycle RED:** The historical reviewed packet's `RuntimeCheckpointCoalescingTests` 8-case filter passed **8/8**. It is not a current-candidate result and travels with the reviewed 24-test packet above; the current full Runtime 1869/1871 status, including the focused successor-materialization RED, is stated in step 4. The former two-file T029c authorization is superseded for this inspection reconciliation; after independent RED review PASS with no P0–P3 finding and control-room approval, T029c is authorized exactly in `CoalescingRuntimeCheckpointCommitStore`, `RuntimeCoalescingSession`, and `CoalescingRuntimeStateStores`. Fusion driver, committer, policy, providers, Evidence, and public contracts remain excluded.
   ...
   **T029f focused D1 successor-materialization RED (complete, 2026-08-06):** The focused command was:
   ...
   remains a separate RED and is not replaced by this focused test. Independent review found P0/P1/P2/P3 all zero and
   passed the RED for implementation gating. Full Runtime remains **1869/1871**, with the D1 `Missing` and focused
   successor-materialization REDs; T029c and T029g onward remain incomplete.
