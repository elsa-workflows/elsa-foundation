...
**Status:** The Path A recovery-authority decision and T029 ownership correction are approved. T029e is complete as its bounded Runtime live-carrier resolution; T029a–T029d remain the blocked spec-123 follow-up work. These decisions implement the approved spec and are not ratification records.
