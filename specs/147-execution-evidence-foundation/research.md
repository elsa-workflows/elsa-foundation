...
**Status:** The Path A recovery-authority decision and T029 ownership correction are approved. T029e is complete as its bounded Runtime live-carrier resolution; T029a and T029b are independently PASSed and control-room APPROVED, T029c remains pending implementation, and T029d remains the unfiltered spec-123 verification gate. These decisions implement the approved spec and are not ratification records.
