...
- [ ] T051 [P] [US3] Extend the separate SQLite provider leaf, referencing the provider-neutral shared contract project, with close/reopen and schema-drift hooks in `tests/Elsa/Persistence/Groundwork/DesignConformance/Sqlite/Tests/SqliteDesignProviderFixture.cs`
- [ ] T052 [P] [US3] Add a separate SQL Server fixture test project, referencing the provider-neutral shared contract project, with Testcontainers and native plan capture in `tests/Elsa/Persistence/Groundwork/DesignConformance/SqlServer.Tests/SqlServerDesignProviderFixture.cs`
- [ ] T053 [P] [US3] Add a separate PostgreSQL fixture test project, referencing the provider-neutral shared contract project, with Testcontainers and native plan capture in `tests/Elsa/Persistence/Groundwork/DesignConformance/PostgreSql.Tests/PostgreSqlDesignProviderFixture.cs`
- [ ] T054 [P] [US3] Add a separate MongoDB fixture test project, referencing the provider-neutral shared contract project, with replica-set and standalone negative fixtures plus winning-plan capture in `tests/Elsa/Persistence/Groundwork/DesignConformance/MongoDb.Tests/MongoDbDesignProviderFixture.cs`
...
- [ ] T064 [US3] Define provider-neutral additive schema/backfill restart, naming collision, drift, cancellation, and safe-apply recovery contracts in `tests/Elsa/Persistence/Groundwork/DesignConformance/Tests/UnifiedSchemaEvolutionContractSuite.cs`, then execute them through concrete fixtures in the owning provider-specific projects under `tests/Elsa/Persistence/Groundwork/DesignConformance/*.Tests/`
