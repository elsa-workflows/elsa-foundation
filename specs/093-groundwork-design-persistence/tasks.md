...
- [ ] T051 [P] [US3] Add a separate SQLite fixture test project, referencing the provider-neutral shared contract project, with close/reopen and schema-drift hooks in `tests/Elsa/Persistence/Groundwork/DesignConformance/Sqlite.Tests/SqliteDesignProviderFixture.cs`
