...
**Branch**: `091-groundwork-diagnostics-persistence` | **Date**: 2026-07-13 | **Spec**: [spec.md](spec.md)
...
**Performance Goals**: Groundwork p95 no worse than 1.25x the ratified EF oracle, throughput at least 80% of the oracle, and p99 no worse than 2x for the approved matrix
...
5. Run the ratified EF-versus-Groundwork performance matrix and resolve material regressions.
