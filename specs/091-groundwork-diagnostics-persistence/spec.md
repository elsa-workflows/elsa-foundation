...
- **SC-006**: Groundwork durable-operation p95 latency is no worse than 1.25 times the EF oracle, throughput is at least 80% of the oracle, and p99 latency is no worse than 2 times the oracle for the ratified workload matrix.
