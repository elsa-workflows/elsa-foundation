# Contract: `ActivityVersionsReconciling`

**Location.** `Elsa.Activities.Design.Reconciliation.Core.ActivityVersionsReconciling`
...
public sealed record ActivityVersionsReconciling(
...
public async Task Reconcile(CancellationToken ct)
{
    ...
    await sender.Send(new ActivityVersionsReconciling(versions), ct);
