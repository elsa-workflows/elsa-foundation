...
| tests/Elsa/Persistence/Groundwork/Tests/GroundworkRuntimeDocumentFixtureTests.cs::Elsa.Persistence.Groundwork.Tests.GroundworkRuntimeDocumentFixtureTests.Committed_Fixture_Loads_Through_The_Bridge_Under_The_Legacy_Stamp | Prove every legacy runtime fixture remains readable through an upcast path. | Replaced by `tests/Elsa/Persistence/Groundwork/Tests/GroundworkRuntimeDocumentFixtureTests.cs::Elsa.Persistence.Groundwork.Tests.GroundworkRuntimeDocumentFixtureTests.Historical_V1_Fixture_Is_Loaded_Or_Explicitly_Rejected_At_A_CleanBreak`, which preserves load evidence for supported versions and adds explicit rejection evidence for the approved Elsa 4 clean break. Elsa 3 compatibility is handled by conversion into Elsa 4 artifacts rather than Elsa 4 runtime document upcasters. | Sipke Schoorstra | Approved | 2026-07-16 |
